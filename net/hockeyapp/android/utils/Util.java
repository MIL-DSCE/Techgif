...
public class Util {
    ...
    static class C04111 extends ThreadLocal<DateFormat> {
        C04111() {
        }
    ...
    static {
        appIdentifierPattern = Pattern.compile(APP_IDENTIFIER_PATTERN, 2);
        HEX_ARRAY = "0123456789ABCDEF".toCharArray();
        DATE_FORMAT_THREAD_LOCAL = new C04111();
    }
    ...
    public static String getFormString(Map<String, String> params) throws UnsupportedEncodingException {
        ...
        for (String key : params.keySet()) {
            ...
            String key2 = URLEncoder.encode(key2, C0747C.UTF8_NAME);
            protoList.add(key2 + "=" + URLEncoder.encode(value, C0747C.UTF8_NAME));
        }
    ...
    private static Bundle getBundle(Context context) {
        try {
            return context.getPackageManager().getApplicationInfo(context.getPackageName(), MessagesController.UPDATE_MASK_USER_PHONE).metaData;
    ...
    public static String getAppName(Context context) {
        ...
        if (applicationInfo != null) {
            ...
            appTitle = context.getString(C0388R.string.hockeyapp_crash_dialog_app_name_fallback);
        }
        return appTitle;
    }
