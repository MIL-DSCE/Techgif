...
public class SecretPhotoViewer implements NotificationCenterDelegate {
    ...
    /* renamed from: org.telegram.ui.SecretPhotoViewer.1 */
    class C14171 implements OnTouchListener {
        C14171() {
        }
    ...
    /* renamed from: org.telegram.ui.SecretPhotoViewer.2 */
    ...
    private class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            this.drawable = getResources().getDrawable(C0691R.drawable.circle1);
        }
        ...
        private void updateSecretTimeText() {
            if (SecretPhotoViewer.this.currentMessageObject != null) {
                ...
                if (this.currentInfoString == null || !this.currentInfoString.equals(str)) {
                    ...
                    this.infoLayout = new StaticLayout(TextUtils.ellipsize(this.currentInfoString, this.infoPaint, (float) this.infoWidth, TruncateAt.END), this.infoPaint, this.infoWidth, Alignment.ALIGN_NORMAL, TouchHelperCallback.ALPHA_FULL, 0.0f, false);
                    invalidate();
                }
            }
        }
    ...
    public void didReceivedNotification(int id, Object... args) {
        if (id == NotificationCenter.messagesDeleted) {
            ...
            for (int i = 0; i < mids.size(); i++) {
                ...
                Iterator i$ = ((ArrayList) mids.get(key)).iterator();
                while (i$.hasNext()) {
                    if (this.currentMessageObject.getId() == ((Integer) i$.next()).intValue()) {
    ...
    public void setParentActivity(Activity activity) {
        if (this.parentActivity != activity) {
            ...
            this.containerView.setOnTouchListener(new C14171());
    ...
    public void closePhoto() {
        ...
        if (this.parentActivity != null) {
            ...
            AndroidUtilities.runOnUIThread(new C14182());
            try {
                if (this.windowView.getParent() != null) {
                    ((WindowManager) this.parentActivity.getSystemService("window")).removeView(this.windowView);
                }
