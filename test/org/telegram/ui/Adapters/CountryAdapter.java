...
public class CountryAdapter extends BaseSectionsAdapter {
    ...
    /* renamed from: org.telegram.ui.Adapters.CountryAdapter.1 */
    ...
    /* renamed from: org.telegram.ui.Adapters.CountryAdapter.2 */
    class C09312 implements Comparator<Country> {
        C09312() {
        }
    ...
    public CountryAdapter(Context context) {
        ...
        Collections.sort(this.sortedCountries, new C09301());
        for (ArrayList<Country> arr2 : this.countries.values()) {
            Collections.sort(arr2, new C09312());
        }
    }
