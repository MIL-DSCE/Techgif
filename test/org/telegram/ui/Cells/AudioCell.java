...
public class AudioCell extends FrameLayout {
    ...
    class C09841 implements OnClickListener {
        C09841() {
        }
        ...
        public void onClick(View v) {
            ...
            if (!MediaController.getInstance().isPlayingAudio(AudioCell.this.audioEntry.messageObject) || MediaController.getInstance().isAudioPaused()) {
                ...
                if (MediaController.getInstance().setPlaylist(arrayList, AudioCell.this.audioEntry.messageObject)) {
                    AudioCell.this.playButton.setImageResource(C0691R.drawable.audiosend_pause);
            ...
            AudioCell.this.playButton.setImageResource(C0691R.drawable.audiosend_play);
        }
    }
    ...
    public AudioCell(Context context) {
        ...
        this.playButton.setOnClickListener(new C09841());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec((this.needDivider ? 1 : 0) + AndroidUtilities.dp(72.0f), C0747C.ENCODING_PCM_32BIT));
    }
    ...
    public void setAudio(AudioEntry entry, boolean divider, boolean checked) {
        ...
        int i = (!MediaController.getInstance().isPlayingAudio(this.audioEntry.messageObject) || MediaController.getInstance().isAudioPaused()) ? C0691R.drawable.audiosend_play : C0691R.drawable.audiosend_pause;
