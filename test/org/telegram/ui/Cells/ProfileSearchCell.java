...
public class ProfileSearchCell extends BaseCell {
    ...
    public ProfileSearchCell(Context context) {
        ...
        this.drawAlpha = TouchHelperCallback.ALPHA_FULL;
        ...
        if (namePaint == null) {
            ...
            checkDrawable = getResources().getDrawable(C0691R.drawable.check_list);
    ...
    public void buildLayout() {
        ...
        this.nameLayout = new StaticLayout(TextUtils.ellipsize(nameString, currentNamePaint, (float) (nameWidth - AndroidUtilities.dp(12.0f)), TruncateAt.END), currentNamePaint, nameWidth, Alignment.ALIGN_NORMAL, TouchHelperCallback.ALPHA_FULL, 0.0f, false);
        if (this.chat == null || this.subLabel != null) {
            ...
            if (this.subLabel != null) {
                ...
                if (this.user.bot) {
                    onlineString = LocaleController.getString("Bot", C0691R.string.Bot);
                } else {
                    ...
                    if (this.user != null && (this.user.id == UserConfig.getClientUserId() || (this.user.status != null && this.user.status.expires > ConnectionsManager.getInstance().getCurrentTime()))) {
                        ...
                        onlineString = LocaleController.getString("Online", C0691R.string.Online);
                    }
                }
            }
            this.onlineLayout = new StaticLayout(TextUtils.ellipsize(onlineString, currentOnlinePaint, (float) (onlineWidth - AndroidUtilities.dp(12.0f)), TruncateAt.END), currentOnlinePaint, onlineWidth, Alignment.ALIGN_NORMAL, TouchHelperCallback.ALPHA_FULL, 0.0f, false);
    ...
    public void update(int mask) {
        ...
        if (mask != 0) {
            ...
            if (!(continueUpdate || !this.drawCount || (mask & MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) == 0)) {
                TL_dialog dialog = (TL_dialog) MessagesController.getInstance().dialogs_dict.get(Long.valueOf(this.dialog_id));
    ...
    protected void onDraw(Canvas canvas) {
        if (this.user != null || this.chat != null || this.encryptedChat != null) {
            ...
            if (this.drawAlpha != TouchHelperCallback.ALPHA_FULL) {
