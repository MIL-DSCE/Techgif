...
public class TextColorCell extends FrameLayout {
    ...
    public TextColorCell(Context context) {
        ...
        this.colorDrawable = getResources().getDrawable(C0691R.drawable.switch_to_on2);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec((this.needDivider ? 1 : 0) + AndroidUtilities.dp(48.0f), C0747C.ENCODING_PCM_32BIT));
    }
