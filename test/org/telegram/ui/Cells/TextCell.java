...
public class TextCell extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.valueTextView.measure(MeasureSpec.makeMeasureSpec(width - AndroidUtilities.dp(24.0f), LinearLayoutManager.INVALID_OFFSET), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), C0747C.ENCODING_PCM_32BIT));
        this.textView.measure(MeasureSpec.makeMeasureSpec(width - AndroidUtilities.dp(95.0f), LinearLayoutManager.INVALID_OFFSET), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), C0747C.ENCODING_PCM_32BIT));
        this.imageView.measure(MeasureSpec.makeMeasureSpec(width, LinearLayoutManager.INVALID_OFFSET), MeasureSpec.makeMeasureSpec(height, LinearLayoutManager.INVALID_OFFSET));
        this.valueImageView.measure(MeasureSpec.makeMeasureSpec(width, LinearLayoutManager.INVALID_OFFSET), MeasureSpec.makeMeasureSpec(height, LinearLayoutManager.INVALID_OFFSET));
