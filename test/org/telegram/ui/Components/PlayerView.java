...
public class PlayerView extends FrameLayout implements NotificationCenterDelegate {
    ...
    /* renamed from: org.telegram.ui.Components.PlayerView.1 */
    ...
    /* renamed from: org.telegram.ui.Components.PlayerView.2 */
    ...
    /* renamed from: org.telegram.ui.Components.PlayerView.3 */
    ...
    /* renamed from: org.telegram.ui.Components.PlayerView.4 */
    class C18374 extends AnimatorListenerAdapterProxy {
        C18374() {
        }
    ...
    /* renamed from: org.telegram.ui.Components.PlayerView.5 */
    class C18385 extends AnimatorListenerAdapterProxy {
        C18385() {
        }
    ...
    public PlayerView(Context context, BaseFragment parentFragment) {
        ...
        shadow.setBackgroundResource(C0691R.drawable.header_shadow);
        ...
        this.playButton.setOnClickListener(new C11671());
        this.titleTextView = new TextView(context);
        this.titleTextView.setTextColor(Theme.INAPP_PLAYER_TITLE_TEXT_COLOR);
        ...
        closeButton.setImageResource(C0691R.drawable.miniplayer_close);
        closeButton.setScaleType(ScaleType.CENTER);
        addView(closeButton, LayoutHelper.createFrame(36, 36, 53));
        closeButton.setOnClickListener(new C11682());
        setOnClickListener(new C11693());
    }
    ...
    private void checkPlayer(boolean create) {
        ...
        if (messageObject == null || messageObject.getId() == 0) {
            ...
            if (this.visible) {
                ...
                this.animatorSet.addListener(new C18374());
        ...
        if (!this.visible) {
            if (!create) {
                ...
                animatorSet.playTogether(r5);
                this.animatorSet.setDuration(200);
                this.animatorSet.addListener(new C18385());
                this.animatorSet.start();
            }
            this.visible = true;
            setVisibility(0);
        ...
        if (MediaController.getInstance().isAudioPaused()) {
            this.playButton.setImageResource(C0691R.drawable.miniplayer_play);
        } else {
            this.playButton.setImageResource(C0691R.drawable.miniplayer_pause);
        }
        if (this.lastMessageObject != messageObject) {
            ...
            stringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface("fonts/rmedium.ttf"), 0, Theme.INAPP_PLAYER_PERFORMER_TEXT_COLOR), 0, messageObject.getMusicAuthor().length(), 18);
