...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context) {
        ...
        this.mThumbDrawable = context.getResources().getDrawable(C0691R.drawable.switch_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = context.getResources().getDrawable(C0691R.drawable.switch_track);
                ...
                switch (this.mTouchMode) {
                    ...
                    case TOUCH_MODE_DRAGGING /*2*/:
                        ...
                        if (thumbScrollRange != 0) {
                            ...
                            dPos = thumbScrollOffset > 0.0f ? TouchHelperCallback.ALPHA_FULL : GroundOverlayOptions.NO_DIMENSION;
                        }
                        if (LocaleController.isRTL) {
                            dPos = -dPos;
                        }
                        float newPos = constrain(this.thumbPosition + dPos, 0.0f, TouchHelperCallback.ALPHA_FULL);
    ...
    public void setChecked(boolean checked) {
        ...
        if (this.attachedToWindow && this.wasLayout) {
            ...
            setThumbPosition(checked ? TouchHelperCallback.ALPHA_FULL : 0.0f);
        }
        if (this.mTrackDrawable != null) {
    ...
    public void draw(Canvas c) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            int offset = AndroidUtilities.density == 1.5f ? AndroidUtilities.dp(TouchHelperCallback.ALPHA_FULL) : 0;
    ...
    private int getThumbOffset() {
        float position;
        if (LocaleController.isRTL) {
            position = TouchHelperCallback.ALPHA_FULL - this.thumbPosition;
        } else {
