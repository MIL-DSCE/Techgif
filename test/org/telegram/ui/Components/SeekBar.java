...
public class SeekBar {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawRect((float) (thumbWidth / 2), (float) ((this.height / 2) - AndroidUtilities.dp(TouchHelperCallback.ALPHA_FULL)), (float) (this.width - (thumbWidth / 2)), (float) ((this.height / 2) + AndroidUtilities.dp(TouchHelperCallback.ALPHA_FULL)), innerPaint);
        canvas.drawRect((float) (thumbWidth / 2), (float) ((this.height / 2) - AndroidUtilities.dp(TouchHelperCallback.ALPHA_FULL)), (float) ((thumbWidth / 2) + this.thumbX), (float) ((this.height / 2) + AndroidUtilities.dp(TouchHelperCallback.ALPHA_FULL)), outerPaint);
