    ...
    protected void onDraw(Canvas canvas) {
        if (getVisibility() == 0) {
            ...
            if (this.progress <= 0.5f) {
                ...
                checkProgress = TouchHelperCallback.ALPHA_FULL;
                backgroundPaint.setColor(this.color);
            }
            if (this.isDisabled) {
                backgroundPaint.setColor(-5197648);
            }
            float bounce = ((float) AndroidUtilities.dp(TouchHelperCallback.ALPHA_FULL)) * bounceProgress;
            ...
            if (checkProgress != TouchHelperCallback.ALPHA_FULL) {
            ...
            if (this.progress > 0.5f) {
                this.drawCanvas.drawLine((float) AndroidUtilities.dp(7.5f), (float) ((int) AndroidUtilities.dpf2(13.5f)), (float) ((int) (((float) AndroidUtilities.dp(7.5f)) - (((float) AndroidUtilities.dp(5.0f)) * (TouchHelperCallback.ALPHA_FULL - bounceProgress)))), (float) ((int) (AndroidUtilities.dpf2(13.5f) - (((float) AndroidUtilities.dp(5.0f)) * (TouchHelperCallback.ALPHA_FULL - bounceProgress)))), checkPaint);
                this.drawCanvas.drawLine((float) ((int) AndroidUtilities.dpf2(6.5f)), (float) ((int) AndroidUtilities.dpf2(13.5f)), (float) ((int) (AndroidUtilities.dpf2(6.5f) + (((float) AndroidUtilities.dp(9.0f)) * (TouchHelperCallback.ALPHA_FULL - bounceProgress)))), (float) ((int) (AndroidUtilities.dpf2(13.5f) - (((float) AndroidUtilities.dp(9.0f)) * (TouchHelperCallback.ALPHA_FULL - bounceProgress)))), checkPaint);
            }
