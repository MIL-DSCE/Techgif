...
public class VideoTimelineView extends View {
    ...
    class C11951 extends AsyncTask<Integer, Integer, Bitmap> {
    ...
    private void init(Context context) {
        ...
        this.pickDrawable = getResources().getDrawable(C0691R.drawable.videotrimmer);
    }
    ...
    public VideoTimelineView(Context context) {
        ...
        this.progressRight = TouchHelperCallback.ALPHA_FULL;
