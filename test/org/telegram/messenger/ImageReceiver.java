...
public class ImageReceiver implements NotificationCenterDelegate {
    ...
    public ImageReceiver(View view) {
        ...
        this.overrideAlpha = TouchHelperCallback.ALPHA_FULL;
    ...
    public void setImage(TLObject fileLocation, String httpUrl, String filter, Drawable thumb, FileLocation thumbLocation, String thumbFilter, int size, String ext, boolean cacheOnly) {
        ...
        if (!(fileLocation == null && httpUrl == null && thumbLocation == null) && (fileLocation == null || (fileLocation instanceof TL_fileLocation) || (fileLocation instanceof TL_fileEncryptedLocation) || (fileLocation instanceof TL_document) || (fileLocation instanceof TL_documentEncrypted))) {
            ...
            this.currentAlpha = TouchHelperCallback.ALPHA_FULL;
            if (this.delegate != null) {
                imageReceiverDelegate = this.delegate;
                z = (this.currentImage == null && this.currentThumb == null && this.staticThumb == null) ? false : true;
    ...
    private void checkAlphaAnimation(boolean skip) {
        if (this.currentAlpha != TouchHelperCallback.ALPHA_FULL) {
            if (!skip) {
        ...
        try {
            ...
            if (drawable != null) {
                ...
                if (this.crossfadeAlpha == null) {
                    ...
                    if (this.crossfadeWithThumb && this.currentAlpha != TouchHelperCallback.ALPHA_FULL) {
    ...
    protected boolean setImageBitmapByKey(BitmapDrawable bitmap, String key, boolean thumb, boolean memCache) {
        ...
        if (thumb) {
            ...
            if (memCache || this.forcePreview) {
                this.currentAlpha = TouchHelperCallback.ALPHA_FULL;
            } else if ((this.currentThumb == null && this.staticThumb == null) || this.currentAlpha == TouchHelperCallback.ALPHA_FULL) {
                this.currentAlpha = 0.0f;
                this.lastUpdateAlphaTime = System.currentTimeMillis();
                if (this.currentThumb == null && this.staticThumb == null) {
                    z2 = false;
