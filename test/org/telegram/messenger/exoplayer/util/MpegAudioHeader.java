...
public final class MpegAudioHeader {
    ...
    static {
        ...
        BITRATE_V1_L1 = new int[]{32, 64, 96, MessagesController.UPDATE_MASK_USER_PHONE, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE, 288, 320, 352, 384, 416, 448};
        BITRATE_V2_L1 = new int[]{32, 48, 56, 64, 80, 96, 112, MessagesController.UPDATE_MASK_USER_PHONE, 144, 160, 176, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE};
        BITRATE_V1_L2 = new int[]{32, 48, 56, 64, 80, 96, 112, MessagesController.UPDATE_MASK_USER_PHONE, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE, 320, 384};
        BITRATE_V1_L3 = new int[]{32, 40, 48, 56, 64, 80, 96, 112, MessagesController.UPDATE_MASK_USER_PHONE, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE, 320};
        BITRATE_V2 = new int[]{8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, MessagesController.UPDATE_MASK_USER_PHONE, 144, 160};
    }
