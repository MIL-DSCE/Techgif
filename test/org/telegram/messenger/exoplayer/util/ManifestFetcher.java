...
public class ManifestFetcher<T> implements Callback {
    ...
    /* renamed from: org.telegram.messenger.exoplayer.util.ManifestFetcher.1 */
    ...
    /* renamed from: org.telegram.messenger.exoplayer.util.ManifestFetcher.2 */
    class C07902 implements Runnable {
        C07902() {
        }
    ...
    /* renamed from: org.telegram.messenger.exoplayer.util.ManifestFetcher.3 */
    class C07913 implements Runnable {
        final /* synthetic */ IOException val$e;

        C07913(IOException iOException) {
    ...
    private void notifyManifestRefreshStarted() {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C07891());
        }
    }

    private void notifyManifestRefreshed() {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C07902());
        }
    }

    private void notifyManifestError(IOException e) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C07913(e));
        }
    }
}
