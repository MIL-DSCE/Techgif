...
public final class DefaultBandwidthMeter implements BandwidthMeter {
    ...
    /* renamed from: org.telegram.messenger.exoplayer.upstream.DefaultBandwidthMeter.1 */
    ...
    private void notifyBandwidthSample(int elapsedMs, long bytes, long bitrate) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C07871(elapsedMs, bytes, bitrate));
        }
    }
}
