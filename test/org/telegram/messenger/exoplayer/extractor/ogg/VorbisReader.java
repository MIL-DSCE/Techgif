...
final class VorbisReader extends StreamReader implements SeekMap {
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws IOException, InterruptedException {
        if (this.totalSamples == 0) {
            ...
            if (this.inputLength == -1) {
                ...
                j = (this.totalSamples * C0747C.MICROS_PER_SECOND) / this.vorbisSetup.idHeader.sampleRate;
            }
            this.duration = j;
        ...
        if ((this.scratch.data[0] & 1) != 1) {
            ...
            if (this.elapsedSamples + ((long) samplesInPacket) >= this.targetGranule) {
                ...
                long timeUs = (this.elapsedSamples * C0747C.MICROS_PER_SECOND) / this.vorbisSetup.idHeader.sampleRate;
    ...
    public long getPosition(long timeUs) {
        ...
        this.targetGranule = (this.vorbisSetup.idHeader.sampleRate * timeUs) / C0747C.MICROS_PER_SECOND;
