...
public class Bitmaps {
    ...
    static class C04281 extends ThreadLocal<byte[]> {
        C04281() {
        }
    ...
    public static Bitmap createBitmap(int width, int height, Config config) {
        ...
        if (VERSION.SDK_INT < 21) {
            ...
            array[77] = (byte) (height & NalUnitUtil.EXTENDED_SAR);
            array[78] = (byte) (width >> 8);
            array[79] = (byte) (width & NalUnitUtil.EXTENDED_SAR);
    ...
    public static Bitmap createBitmap(Bitmap source, int x, int y, int width, int height, Matrix m, boolean filter) {
        ...
        if (x + width > source.getWidth()) {
            ...
            if (config != null) {
                switch (C04292.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
