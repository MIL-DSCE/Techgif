...
public class OutputSurface implements OnFrameAvailableListener {
    ...
    private void eglSetup(int width, int height) {
        ...
        if (this.mEGLDisplay == EGL10.EGL_NO_DISPLAY) {
            ...
            if (this.mEGL.eglChooseConfig(this.mEGLDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12339, 1, 12352, EGL_OPENGL_ES2_BIT, 12344}, configs, configs.length, new int[1])) {
