...
public class InputSurface {
    ...
    private void eglSetup() {
        ...
        if (EGL14.eglInitialize(this.mEGLDisplay, version, 0, version, 1)) {
            ...
            if (EGL14.eglChooseConfig(this.mEGLDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, 12352, EGL_OPENGL_ES2_BIT, EGL_RECORDABLE_ANDROID, 1, 12344}, 0, configs, 0, configs.length, new int[1], 0)) {
