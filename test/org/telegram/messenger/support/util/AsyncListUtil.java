...
public class AsyncListUtil<T> {
    ...
    class C17221 implements MainThreadCallback<T> {
        C17221() {
        }
    ...
    class C17232 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C17221();
        this.mBackgroundCallback = new C17232();
        this.mTClass = klass;
