...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            static class C08611 implements Creator<FullSpanItem> {
                C08611() {
                }
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C08621 implements Creator<SavedState> {
            C08621() {
            }
    ...
    /* renamed from: org.telegram.messenger.support.widget.StaggeredGridLayoutManager.2 */
    class C20062 extends LinearSmoothScroller {
        C20062(Context x0) {
            super(x0);
        }
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mCheckForGapsRunnable = new C08601();
    ...
    private void repositionToWrapContentIfNecessary() {
        if (this.mSecondaryOrientation.getMode() != C0747C.ENCODING_PCM_32BIT) {
            int i;
            View child;
            float maxSize = 0.0f;
            ...
            for (i = HORIZONTAL; i < childCount; i += VERTICAL) {
                ...
                if (size >= maxSize) {
                    if (((LayoutParams) child.getLayoutParams()).isFullSpan()) {
                        size = (TouchHelperCallback.ALPHA_FULL * size) / ((float) this.mSpanCount);
                    }
    ...
    private int updateSpecWithExtra(int spec, int startInset, int endInset) {
        ...
        if (mode == INVALID_OFFSET || mode == C0747C.ENCODING_PCM_32BIT) {
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int position) {
        LinearSmoothScroller scroller = new C20062(recyclerView.getContext());
