...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static class C08583 implements Interpolator {
        C08583() {
        }

        public float getInterpolation(float t) {
            t -= TouchHelperCallback.ALPHA_FULL;
            return ((((t * t) * t) * t) * t) + TouchHelperCallback.ALPHA_FULL;
        }
    }
    ...
    public static abstract class LayoutManager {
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = C0747C.ENCODING_PCM_32BIT;
            this.mHeightMode = C0747C.ENCODING_PCM_32BIT;
        }
        ...
        public void ignoreView(View view) {
            ...
            vh.addFlags(MessagesController.UPDATE_MASK_USER_PHONE);
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = C0747C.ENCODING_PCM_32BIT;
                } else {
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                ...
                resultSize = size;
                resultMode = (parentMode == LinearLayoutManager.INVALID_OFFSET || parentMode == C0747C.ENCODING_PCM_32BIT) ? LinearLayoutManager.INVALID_OFFSET : RecyclerView.TOUCH_SLOP_DEFAULT;
            }
            return MeasureSpec.makeMeasureSpec(resultSize, resultMode);
        }
        ...
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, AccessibilityNodeInfoCompat info) {
            if (ViewCompat.canScrollVertically(this.mRecyclerView, RecyclerView.NO_POSITION) || ViewCompat.canScrollHorizontally(this.mRecyclerView, RecyclerView.NO_POSITION)) {
                info.addAction((int) MessagesController.UPDATE_MASK_CHANNEL);
            ...
            if (ViewCompat.canScrollVertically(this.mRecyclerView, RecyclerView.VERTICAL) || ViewCompat.canScrollHorizontally(this.mRecyclerView, RecyclerView.VERTICAL)) {
                info.addAction((int) MessagesController.UPDATE_MASK_SEND_STATE);
                info.setScrollable(true);
            }
        ...
        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), C0747C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), C0747C.ENCODING_PCM_32BIT));
        }
    ...
    public final class Recycler {
        ...
        View getViewForPosition(int position, boolean dryRun) {
            ...
            if (fromScrap && !RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(MessagesController.UPDATE_MASK_CHANNEL)) {
                holder.setFlags(RecyclerView.TOUCH_SLOP_DEFAULT, MessagesController.UPDATE_MASK_CHANNEL);
                if (RecyclerView.this.mState.mRunSimpleAnimations) {
                    RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(holder, RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, holder, ItemAnimator.buildAdapterChangeFlagsForAnimations(holder) | MessagesController.UPDATE_MASK_SEND_STATE, holder.getUnmodifiedPayloads()));
                }
            }
        ...
        void setAdapterPositionsAsUnknown() {
            ...
            for (int i = RecyclerView.TOUCH_SLOP_DEFAULT; i < cachedCount; i += RecyclerView.VERTICAL) {
                ViewHolder holder = (ViewHolder) this.mCachedViews.get(i);
                if (holder != null) {
                    holder.addFlags(MessagesController.UPDATE_MASK_SELECT_DIALOG);
                }
            }
        }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mScroller.fling(RecyclerView.TOUCH_SLOP_DEFAULT, RecyclerView.TOUCH_SLOP_DEFAULT, velocityX, velocityY, LinearLayoutManager.INVALID_OFFSET, ConnectionsManager.DEFAULT_DATACENTER_ID, LinearLayoutManager.INVALID_OFFSET, ConnectionsManager.DEFAULT_DATACENTER_ID);
            postOnAnimation();
        }
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            float distance = ((float) halfContainerSize) + (((float) halfContainerSize) * distanceInfluenceForSnapDuration(Math.min(TouchHelperCallback.ALPHA_FULL, (TouchHelperCallback.ALPHA_FULL * ((float) delta)) / ((float) containerSize))));
            if (velocity > 0) {
                ...
                duration = (int) (((((float) absDx) / ((float) containerSize)) + TouchHelperCallback.ALPHA_FULL) * BitmapDescriptorFactory.HUE_MAGENTA);
            }
    ...
    class C17284 implements ProcessCallback {
        C17284() {
        }
    ...
    class C17295 implements Callback {
        C17295() {
        }
        ...
        public void detachViewFromParent(int offset) {
            ...
            if (view != null) {
                ...
                if (vh != null) {
                    if (!vh.isTmpDetached() || vh.shouldIgnore()) {
                        vh.addFlags(MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE);
                    } else {
    ...
    class C17306 implements Callback {
        C17306() {
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C08583();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C08561();
        ...
        this.mItemAnimatorRunner = new C08572();
        this.mViewInfoProcessCallback = new C17284();
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return className.indexOf(46) == NO_POSITION ? RecyclerView.class.getPackage().getName() + '.' + className : className;
    }

    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C17295());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C17306());
    }
    ...
    private void pullGlows(float x, float overscrollX, float y, float overscrollY) {
        ...
        if (overscrollX < 0.0f) {
            ensureLeftGlow();
            if (this.mLeftGlow.onPull((-overscrollX) / ((float) getWidth()), TouchHelperCallback.ALPHA_FULL - (y / ((float) getHeight())))) {
                invalidate = true;
            }
        ...
        if (overscrollY < 0.0f) {
            ...
            ensureBottomGlow();
            if (this.mBottomGlow.onPull(overscrollY / ((float) getHeight()), TouchHelperCallback.ALPHA_FULL - (x / ((float) getWidth())))) {
                invalidate = true;
            }
        }
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (this.mLayout == null) {
            ...
            if (widthMode == C0747C.ENCODING_PCM_32BIT && heightMode == C0747C.ENCODING_PCM_32BIT) {
                skipMeasure = true;
            }
            ...
            if (!skipMeasure && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), C0747C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), C0747C.ENCODING_PCM_32BIT));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        if (flags != 0 && isAccessibilityEnabled()) {
            ...
            event.setEventType(MessagesController.UPDATE_MASK_NEW_MESSAGE);
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (i = TOUCH_SLOP_DEFAULT; i < this.mChildHelper.getChildCount(); i += VERTICAL) {
                ...
                if (!(viewHolder.shouldIgnore() || this.mViewInfoStore.isInPreLayout(viewHolder))) {
                    ...
                    if (!wasHidden) {
                        flags |= MessagesController.UPDATE_MASK_SEND_STATE;
                    }
