...
public class StringToType {
    ...
    static class C04211 implements ParameterizedType {
        final /* synthetic */ Class val$baseClass;
        final /* synthetic */ Type[] val$typeParams;

        C04211(Type[] typeArr, Class cls) {
    ...
    private static Type makeParameterizedType(String typeName, Class classScope) throws ClassNotFoundException {
        ...
        return new C04211(commaSeparatedListToTypeArray(typeName.substring(paramStart + 1, typeName.lastIndexOf(62)), classScope), Class.forName(typeName.substring(0, paramStart), false, classScope.getClassLoader()));
    }
}
