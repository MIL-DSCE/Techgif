...
public class PaintView extends ImageView {
    ...
    class C04171 extends AsyncTask<Object, Void, Bitmap> {
        C04171() {
        }
    ...
    public static int determineOrientation(ContentResolver resolver, Uri imageUri) {
        ...
        try {
            ...
            if (((float) options.outWidth) / ((float) options.outHeight) > TouchHelperCallback.ALPHA_FULL) {
                return 0;
            }
            return 1;
        } catch (Throwable e) {
    ...
    public PaintView(Context context, Uri imageUri, int displayWidth, int displayHeight) {
        ...
        new C04171().execute(new Object[]{context, imageUri, Integer.valueOf(displayWidth), Integer.valueOf(displayHeight)});
    }
