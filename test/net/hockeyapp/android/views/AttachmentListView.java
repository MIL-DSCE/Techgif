    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                child.measure(MeasureSpec.makeMeasureSpec(width, LinearLayoutManager.INVALID_OFFSET), MeasureSpec.makeMeasureSpec(height, LinearLayoutManager.INVALID_OFFSET));
        ...
        } else if (MeasureSpec.getMode(heightMeasureSpec) == LinearLayoutManager.INVALID_OFFSET && (yPos + line_height) + getPaddingBottom() < height) {
            height = (yPos + line_height) + getPaddingBottom();
        }
