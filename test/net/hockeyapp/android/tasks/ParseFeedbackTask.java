...
public class ParseFeedbackTask extends AsyncTask<Void, Void, FeedbackResponse> {
    ...
    private void startNotification(Context context) {
        if (this.mUrlString != null) {
            ...
            Notification notification = Util.createNotification(context, PendingIntent.getActivity(context, 0, intent, C0747C.ENCODING_PCM_32BIT), "HockeyApp Feedback", "A new answer to your feedback is available.", iconId);
