...
public class HandlerBox extends AbstractFullBox {
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        this.f44a = IsoTypeReader.readUInt32(content);
        this.f45b = IsoTypeReader.readUInt32(content);
        this.f46c = IsoTypeReader.readUInt32(content);
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter.writeUInt32(byteBuffer, this.f44a);
        IsoTypeWriter.writeUInt32(byteBuffer, this.f45b);
        IsoTypeWriter.writeUInt32(byteBuffer, this.f46c);
        if (this.name != null) {
