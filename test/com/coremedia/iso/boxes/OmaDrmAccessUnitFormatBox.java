...
public final class OmaDrmAccessUnitFormatBox extends AbstractFullBox {
    ...
    public void setAllBits(byte allBits) {
        ...
        this.selectiveEncryption = (allBits & MessagesController.UPDATE_MASK_USER_PHONE) == MessagesController.UPDATE_MASK_USER_PHONE;
    }

    public void _parseDetails(ByteBuffer content) {
        parseVersionAndFlags(content);
        this.allBits = (byte) IsoTypeReader.readUInt8(content);
        this.selectiveEncryption = (this.allBits & MessagesController.UPDATE_MASK_USER_PHONE) == MessagesController.UPDATE_MASK_USER_PHONE;
