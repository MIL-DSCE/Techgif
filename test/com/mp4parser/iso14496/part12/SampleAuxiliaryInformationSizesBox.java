...
public class SampleAuxiliaryInformationSizesBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_6 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setDefaultSampleInfoSize", "com.mp4parser.iso14496.part12.SampleAuxiliaryInformationSizesBox", "int", "defaultSampleInfoSize", TtmlNode.ANONYMOUS_REGION_ID, "void"), (int) TransportMediator.KEYCODE_MEDIA_PAUSE);
    ...
    public void setDefaultSampleInfoSize(int defaultSampleInfoSize) {
        ...
        if ($assertionsDisabled || defaultSampleInfoSize <= NalUnitUtil.EXTENDED_SAR) {
