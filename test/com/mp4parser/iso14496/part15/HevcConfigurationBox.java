...
public class HevcConfigurationBox extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_20 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "getConstantFrameRate", "com.mp4parser.iso14496.part15.HevcConfigurationBox", TtmlNode.ANONYMOUS_REGION_ID, TtmlNode.ANONYMOUS_REGION_ID, TtmlNode.ANONYMOUS_REGION_ID, "int"), (int) MessagesController.UPDATE_MASK_USER_PHONE);
