    ...
    public static class LookAhead {
        ...
        public boolean nextThreeEquals001() throws IOException {
            if (this.buffer.limit() - this.inBufferPos >= 3) {
                if (this.buffer.get(this.inBufferPos) == null && this.buffer.get(this.inBufferPos + 1) == null && this.buffer.get(this.inBufferPos + 2) == (byte) 1) {
                    return true;
                }
                return false;
        ...
        public boolean nextThreeEquals000or001orEof() throws IOException {
            if (this.buffer.limit() - this.inBufferPos >= 3) {
                if (this.buffer.get(this.inBufferPos) == null && this.buffer.get(this.inBufferPos + 1) == null && (this.buffer.get(this.inBufferPos + 2) == null || this.buffer.get(this.inBufferPos + 2) == (byte) 1)) {
                    return true;
                }
                return false;
            } else if ((this.bufferStartPos + ((long) this.inBufferPos)) + 3 <= this.dataSource.size()) {
