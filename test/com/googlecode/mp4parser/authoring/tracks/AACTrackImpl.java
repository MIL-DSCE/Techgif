...
public class AACTrackImpl extends AbstractTrack {
    ...
    static {
        ...
        samplingFrequencyIndexMap.put(Integer.valueOf(11), Integer.valueOf(DefaultHttpDataSource.DEFAULT_READ_TIMEOUT_MILLIS));
    }
    ...
    private AdtsHeader readSamples(DataSource channel) throws IOException {
        ...
        while (true) {
            ...
            this.samples.add(new C16591(channel.position(), (long) (hdr.frameLength - hdr.getSize())));
