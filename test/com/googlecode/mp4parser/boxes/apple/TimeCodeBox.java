...
public class TimeCodeBox extends AbstractBox implements SampleEntry {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_10 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setReserved1", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "int", "reserved1", TtmlNode.ANONYMOUS_REGION_ID, "void"), (int) TransportMediator.KEYCODE_MEDIA_RECORD);
        ...
        ajc$tjp_9 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "getReserved1", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", TtmlNode.ANONYMOUS_REGION_ID, TtmlNode.ANONYMOUS_REGION_ID, TtmlNode.ANONYMOUS_REGION_ID, "int"), (int) TransportMediator.KEYCODE_MEDIA_PLAY);
    }
