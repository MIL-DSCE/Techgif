...
public class TemporalLevelEntry extends GroupEntry {
    ...
    public void parse(ByteBuffer byteBuffer) {
        this.levelIndependentlyDecodable = (byteBuffer.get() & MessagesController.UPDATE_MASK_USER_PHONE) == MessagesController.UPDATE_MASK_USER_PHONE;
    }

    public ByteBuffer get() {
        ByteBuffer content = ByteBuffer.allocate(1);
        content.put((byte) (this.levelIndependentlyDecodable ? MessagesController.UPDATE_MASK_USER_PHONE : 0));
        content.rewind();
        return content;
    }
