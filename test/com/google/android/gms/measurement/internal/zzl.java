...
public final class zzl {
    ...
    static {
        ...
        zzaWh = zza.zzD("measurement.upload.max_batch_size", AccessibilityNodeInfoCompat.ACTION_CUT);
        zzaWi = zza.zzD("measurement.upload.max_bundle_size", AccessibilityNodeInfoCompat.ACTION_CUT);
        ...
        zzaWy = zza.zze("measurement.service_client.idle_disconnect_millis", HlsChunkSource.DEFAULT_MIN_BUFFER_TO_SWITCH_UP_MS);
    }
}
