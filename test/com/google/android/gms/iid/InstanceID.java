...
public class InstanceID {
    ...
    protected InstanceID(Context context, String subtype, Bundle options) {
        this.zzaMT = TtmlNode.ANONYMOUS_REGION_ID;
    ...
    public void zzb(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("subtype", TtmlNode.ANONYMOUS_REGION_ID.equals(this.zzaMT) ? str : this.zzaMT);
        String str3 = "X-subtype";
        if (!TtmlNode.ANONYMOUS_REGION_ID.equals(this.zzaMT)) {
            str = this.zzaMT;
        }
    ...
    public String zzc(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString(C2DMessaging.EXTRA_SENDER, str);
        String str3 = TtmlNode.ANONYMOUS_REGION_ID.equals(this.zzaMT) ? str : this.zzaMT;
