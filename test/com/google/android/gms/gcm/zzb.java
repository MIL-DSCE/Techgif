...
class zzb {
    ...
    private PendingIntent zzC(Bundle bundle) {
        ...
        return PendingIntent.getActivity(this.mContext, zzyj(), intent, C0747C.ENCODING_PCM_32BIT);
    }

    private PendingIntent zzD(Bundle bundle) {
        Intent intent = new Intent("com.google.android.gms.gcm.NOTIFICATION_DISMISS");
        zza(intent, bundle);
        return PendingIntent.getService(this.mContext, zzyj(), intent, C0747C.ENCODING_PCM_32BIT);
    }
