...
public class zzq {
    ...
    class C01961 implements Runnable {
        ...
        C01961(zzq com_google_android_gms_ads_internal_zzq, WeakReference weakReference) {
    ...
    zzq(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzq_zza) {
        ...
        this.zzx = new C01961(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
