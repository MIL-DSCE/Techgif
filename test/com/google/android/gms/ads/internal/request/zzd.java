...
public abstract class zzd implements com.google.android.gms.ads.internal.request.zzc.zza, zzit<Void> {
    ...
    class C15291 implements zzc<AdRequestInfoParcel> {
        final /* synthetic */ zzj zzHn;
        final /* synthetic */ zzd zzHo;

        C15291(zzd com_google_android_gms_ads_internal_request_zzd, zzj com_google_android_gms_ads_internal_request_zzj) {
    ...
    class C15302 implements com.google.android.gms.internal.zzji.zza {
        final /* synthetic */ zzd zzHo;

        C15302(zzd com_google_android_gms_ads_internal_request_zzd) {
            this.zzHo = com_google_android_gms_ads_internal_request_zzd;
        }
    ...
    public Void zzga() {
        ...
        if (zzgs == null) {
            ...
            this.zzHl.zza(new C15291(this, zzgs), new C15302(this));
        }
        return null;
    }
