...
public abstract class zzc extends zzb implements zzg, zzft {
    ...
    class C01862 implements Runnable {
        ...
        C01862(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza) {
    ...
    class C01893 implements Runnable {
        ...
        class C01871 implements OnTouchListener {
            final /* synthetic */ zze zzpu;
            final /* synthetic */ C01893 zzpv;

            C01871(C01893 c01893, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c01893;
        ...
        class C01882 implements OnClickListener {
            ...
            C01882(C01893 c01893, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c01893;
                this.zzpu = com_google_android_gms_ads_internal_zze;
            }
        ...
        C01893(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
            this.zzps = com_google_android_gms_internal_zzif_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C01871(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C01882(this, com_google_android_gms_ads_internal_zze));
    ...
    class C15331 implements zzdf {
        final /* synthetic */ zzc zzpr;

        C15331(zzc com_google_android_gms_ads_internal_zzc) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
        }
    ...
    protected void zza(zzeh com_google_android_gms_internal_zzeh) {
        com_google_android_gms_internal_zzeh.zza("/trackActiveViewUnit", new C15331(this));
    }
    ...
    protected void zza(zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
        if (com_google_android_gms_internal_zzif_zza.errorCode != -2) {
            zzir.zzMc.post(new C01862(this, com_google_android_gms_internal_zzif_zza));
            return;
        }
        ...
        if (!com_google_android_gms_internal_zzif_zza.zzLe.zzHT || com_google_android_gms_internal_zzif_zza.zzLe.zzum) {
            zzir.zzMc.post(new C01893(this, com_google_android_gms_internal_zzif_zza, com_google_android_gms_internal_zzcb));
            return;
        }
        this.zzpj.zzrL = 0;
