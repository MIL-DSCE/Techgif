...
public final class zzs implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void zzbY() {
            zzin.m22v("Disable position monitoring on adFrame.");
            if (this.zzrV != null) {
                this.zzrV.zzhF();
            }
        }
    ...
    public String zzca() {
        return (this.zzrR && this.zzrS) ? TtmlNode.ANONYMOUS_REGION_ID : this.zzrR ? this.zzrT ? "top-scrollable" : "top-locked" : this.zzrS ? this.zzrT ? "bottom-scrollable" : "bottom-locked" : TtmlNode.ANONYMOUS_REGION_ID;
    }
