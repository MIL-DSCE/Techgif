...
public interface zzsz {
    ...
    public static final class zzb extends zzso<zzb> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.zzbuN.equals(TtmlNode.ANONYMOUS_REGION_ID)) {
                output.zzn(2, this.zzbuN);
            }
            if (!this.version.equals(TtmlNode.ANONYMOUS_REGION_ID)) {
        ...
        public zzb zzJD() {
            this.zzbuM = 0;
            this.zzbuN = TtmlNode.ANONYMOUS_REGION_ID;
            this.version = TtmlNode.ANONYMOUS_REGION_ID;
            this.zzbuj = null;
            this.zzbuu = -1;
            return this;
        }
        ...
        protected int zzz() {
            ...
            return !this.version.equals(TtmlNode.ANONYMOUS_REGION_ID) ? zzz + zzsn.zzo(3, this.version) : zzz;
        }
    }
    ...
    public static final class zzd extends zzso<zzd> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.tag.equals(TtmlNode.ANONYMOUS_REGION_ID)) {
            ...
            if (!this.zzbvc.equals(TtmlNode.ANONYMOUS_REGION_ID)) {
        ...
        public zzd zzJF() {
            ...
            this.zzbvb = null;
            this.zzbvc = TtmlNode.ANONYMOUS_REGION_ID;
            this.zzbvd = 180000;
            this.zzbve = null;
    ...
    public static final class zze extends zzso<zze> {
        ...
        public void writeTo(zzsn output) throws IOException {
            if (!this.key.equals(TtmlNode.ANONYMOUS_REGION_ID)) {
                output.zzn(1, this.key);
            }
            if (!this.value.equals(TtmlNode.ANONYMOUS_REGION_ID)) {
        ...
        public zze zzJH() {
            this.key = TtmlNode.ANONYMOUS_REGION_ID;
        ...
        protected int zzz() {
            ...
            return !this.value.equals(TtmlNode.ANONYMOUS_REGION_ID) ? zzz + zzsn.zzo(2, this.value) : zzz;
        }
    }
}
