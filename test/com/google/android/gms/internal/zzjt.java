...
class zzjt extends WebView implements OnGlobalLayoutListener, DownloadListener, zzjp {
    ...
    class C03101 implements Runnable {
        ...
        C03101(zzjt com_google_android_gms_internal_zzjt) {
    ...
    protected zzjt(zza com_google_android_gms_internal_zzjt_zza, AdSizeParcel adSizeParcel, boolean z, boolean z2, zzan com_google_android_gms_internal_zzan, VersionInfoParcel versionInfoParcel, zzcb com_google_android_gms_internal_zzcb, com.google.android.gms.ads.internal.zzd com_google_android_gms_ads_internal_zzd) {
        ...
        this.zzNX = true;
        this.zzEY = TtmlNode.ANONYMOUS_REGION_ID;
        this.zzDD = -1;
        this.zzDC = -1;
        this.zzDF = -1;
        this.zzDG = -1;
    ...
    public void destroy() {
        synchronized (this.zzpV) {
            ...
            zzit();
            this.zzNT = true;
            zzin.m22v("Initiating WebView self destruct sequence in 3...");
            this.zzNQ.zzii();
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        synchronized (this.zzpV) {
            if (isDestroyed()) {
                ...
                mode = (mode == LinearLayoutManager.INVALID_OFFSET || mode == C0747C.ENCODING_PCM_32BIT) ? size : Integer.MAX_VALUE;
                if (mode2 == LinearLayoutManager.INVALID_OFFSET || mode2 == C0747C.ENCODING_PCM_32BIT) {
                    i = size2;
                }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzin.m22v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzhZ() {
        synchronized (this.zzpV) {
            zzin.m22v("Destroying WebView!");
            zzir.zzMc.post(new C03101(this));
        }
    }
