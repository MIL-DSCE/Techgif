...
public class zzev implements zzem {
    ...
    class C02591 implements Runnable {
        ...
        C02591(zzev com_google_android_gms_internal_zzev, zzes com_google_android_gms_internal_zzes) {
            ...
            for (String str : com_google_android_gms_internal_zzen.zzBB) {
                ...
                synchronized (this.zzpV) {
                    ...
                    if (com_google_android_gms_internal_zzes.zzCq != null) {
                        zzir.zzMc.post(new C02591(this, com_google_android_gms_internal_zzes));
                    }
                }
            }
        }
