...
public class zzjq extends WebViewClient {
    ...
    class C03091 implements Runnable {
        ...
        C03091(zzjq com_google_android_gms_internal_zzjq) {
    ...
    private String zzaN(String str) {
        ...
        return parse.getHost() != null ? parse.getHost() : TtmlNode.ANONYMOUS_REGION_ID;
    }
    ...
    public final void onLoadResource(WebView webView, String url) {
        zzin.m22v("Loading resource: " + url);
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String url) {
        zzin.m22v("AdWebView shouldOverrideUrlLoading: " + url);
        Uri parse = Uri.parse(url);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzh(parse);
    ...
    public final void zzfo() {
        synchronized (this.zzpV) {
            this.zzND = false;
            this.zzsz = true;
            zzir.runOnUiThread(new C03091(this));
        }
    }
    ...
    public void zzh(Uri uri) {
        ...
        if (list != null) {
            ...
            if (com.google.android.gms.ads.internal.util.client.zzb.zzQ(2)) {
                zzin.m22v("Received GMSG: " + path);
                for (String path2 : zze.keySet()) {
                    zzin.m22v("  " + path2 + ": " + ((String) zze.get(path2)));
                }
            }
            for (zzdf zza : list) {
        ...
        zzin.m22v("No GMSG handler found for GMSG: " + uri);
    }
    ...
    public void zzii() {
        synchronized (this.zzpV) {
            zzin.m22v("Loading blank page in WebView, 2...");
            this.zzNH = true;
