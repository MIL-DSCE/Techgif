...
public class zziu {
    ...
    class C03031 implements OnClickListener {
        ...
        C03031(zziu com_google_android_gms_internal_zziu, String str) {
    ...
    class C03042 implements OnClickListener {
        ...
        C03042(zziu com_google_android_gms_internal_zziu) {
            this.zzMm = com_google_android_gms_internal_zziu;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C03031(this, zzaG));
            builder.setNegativeButton("Close", new C03042(this));
            builder.create().show();
            return;
        }
