...
public final class zzbt {
    ...
    static class C02331 implements Callable<Void> {
        final /* synthetic */ Context zzxh;

        C02331(Context context) {
            this.zzxh = context;
        }
    ...
    static {
        ...
        zzvT = zzbp.zza(0, "gads:video_stream_cache:connect_timeout_millis", (int) AdaptiveEvaluator.DEFAULT_MIN_DURATION_FOR_QUALITY_INCREASE_MS);
        zzvU = zzbp.zza(0, "gads:video:metric_reporting_enabled", Boolean.valueOf(false));
        zzvV = zzbp.zza(0, "gads:video:metric_frame_hash_times", TtmlNode.ANONYMOUS_REGION_ID);
