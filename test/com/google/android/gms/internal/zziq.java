...
public final class zziq {
    ...
    static class C02951 implements Callable<Void> {
        final /* synthetic */ Runnable zzLW;

        C02951(Runnable runnable) {
            this.zzLW = runnable;
        }
    ...
    static class C02962 implements Callable<Void> {
        final /* synthetic */ Runnable zzLW;

        C02962(Runnable runnable) {
            this.zzLW = runnable;
        }
    ...
    static class C02973 implements Runnable {
        final /* synthetic */ zzjd zzLX;
        final /* synthetic */ Callable zzLY;

        C02973(zzjd com_google_android_gms_internal_zzjd, Callable callable) {
    ...
    static class C02984 implements Runnable {
        final /* synthetic */ zzjd zzLX;
        final /* synthetic */ Future zzLZ;

        C02984(zzjd com_google_android_gms_internal_zzjd, Future future) {
            this.zzLX = com_google_android_gms_internal_zzjd;
            this.zzLZ = future;
        }
    ...
    static class C02995 implements ThreadFactory {
    ...
    public static zzjg<Void> zza(int i, Runnable runnable) {
        return i == 1 ? zza(zzLV, new C02951(runnable)) : zza(zzLU, new C02962(runnable));
    }
    ...
    public static <T> zzjg<T> zza(ExecutorService executorService, Callable<T> callable) {
        ...
        try {
            com_google_android_gms_internal_zzjd.zzc(new C02984(com_google_android_gms_internal_zzjd, executorService.submit(new C02973(com_google_android_gms_internal_zzjd, callable))));
        } catch (Throwable e) {
