...
public final class zzdm implements zzdf {
    ...
    public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
        ...
        if (str == null) {
            ...
            } else if (C2DMessaging.EXTRA_APPLICATION_PENDING_INTENT.equalsIgnoreCase(str) && "true".equalsIgnoreCase((String) map.get("play_store"))) {
                zze(com_google_android_gms_internal_zzjp, map);
            } else if (C2DMessaging.EXTRA_APPLICATION_PENDING_INTENT.equalsIgnoreCase(str) && "true".equalsIgnoreCase((String) map.get("system_browser"))) {
                zzo(true);
