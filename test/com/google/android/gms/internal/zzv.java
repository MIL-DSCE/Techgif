...
public class zzv implements zzb {
    ...
    static class zza {
        ...
        public static zza zzf(InputStream inputStream) throws IOException {
            ...
            if (com_google_android_gms_internal_zzv_zza.zzb.equals(TtmlNode.ANONYMOUS_REGION_ID)) {
        ...
        public boolean zza(OutputStream outputStream) {
            try {
                ...
                zzv.zza(outputStream, this.zzb == null ? TtmlNode.ANONYMOUS_REGION_ID : this.zzb);
    ...
    static void zza(OutputStream outputStream, String str) throws IOException {
        byte[] bytes = str.getBytes(C0747C.UTF8_NAME);
    ...
    static String zzd(InputStream inputStream) throws IOException {
        return new String(zza(inputStream, (int) zzc(inputStream)), C0747C.UTF8_NAME);
    }
