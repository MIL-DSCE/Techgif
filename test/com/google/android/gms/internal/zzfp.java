...
public class zzfp extends zzfs {
    ...
    class C02731 implements OnClickListener {
        ...
        C02731(zzfp com_google_android_gms_internal_zzfp, String str, String str2) {
    ...
    class C02742 implements OnClickListener {
        ...
        C02742(zzfp com_google_android_gms_internal_zzfp) {
            this.zzDt = com_google_android_gms_internal_zzfp;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzr.zzbC().zzaE(zzal)) {
                    ...
                    zzL.setTitle(zzr.zzbF().zzd(C0159R.string.store_picture_title, "Save image"));
                    zzL.setMessage(zzr.zzbF().zzd(C0159R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzL.setPositiveButton(zzr.zzbF().zzd(C0159R.string.accept, "Accept"), new C02731(this, str, zzal));
                    zzL.setNegativeButton(zzr.zzbF().zzd(C0159R.string.decline, "Decline"), new C02742(this));
                    zzL.create().show();
                    return;
                }
