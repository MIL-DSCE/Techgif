...
class TextToSpeechICSMR1 {
    ...
    static class C00711 extends UtteranceProgressListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00711(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
    ...
    static class C00722 implements OnUtteranceCompletedListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00722(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
            this.val$listener = utteranceProgressListenerICSMR1;
        }
    ...
    static void setUtteranceProgressListener(TextToSpeech tts, UtteranceProgressListenerICSMR1 listener) {
        if (VERSION.SDK_INT >= 15) {
            tts.setOnUtteranceProgressListener(new C00711(listener));
        } else {
            tts.setOnUtteranceCompletedListener(new C00722(listener));
        }
    }
}
