...
class TransportMediatorJellybeanMR2 {
    ...
    class C00525 implements OnGetPlaybackPositionListener {
        C00525() {
        }
    ...
    class C00536 implements OnPlaybackPositionUpdateListener {
        C00536() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        ...
        this.mGetPlaybackPositionListener = new C00525();
        this.mPlaybackPositionUpdateListener = new C00536();
        this.mPlayState = 0;
    ...
    public void refreshState(boolean playing, long position, int transportControls) {
        if (this.mRemoteControl != null) {
            this.mRemoteControl.setPlaybackState(playing ? 3 : 1, position, playing ? TouchHelperCallback.ALPHA_FULL : 0.0f);
