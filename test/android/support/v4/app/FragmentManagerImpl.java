...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder(MessagesController.UPDATE_MASK_USER_PHONE);
    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case ANIM_STYLE_OPEN_ENTER /*1*/:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, TouchHelperCallback.ALPHA_FULL, 0.0f, TouchHelperCallback.ALPHA_FULL);
            case ANIM_STYLE_OPEN_EXIT /*2*/:
                return makeOpenCloseAnimation(this.mHost.getContext(), TouchHelperCallback.ALPHA_FULL, 0.975f, TouchHelperCallback.ALPHA_FULL, 0.0f);
            case ANIM_STYLE_CLOSE_ENTER /*3*/:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, TouchHelperCallback.ALPHA_FULL, 0.0f, TouchHelperCallback.ALPHA_FULL);
            case ANIM_STYLE_CLOSE_EXIT /*4*/:
                return makeOpenCloseAnimation(this.mHost.getContext(), TouchHelperCallback.ALPHA_FULL, 1.075f, TouchHelperCallback.ALPHA_FULL, 0.0f);
            case ANIM_STYLE_FADE_ENTER /*5*/:
                return makeFadeAnimation(this.mHost.getContext(), 0.0f, TouchHelperCallback.ALPHA_FULL);
            case ANIM_STYLE_FADE_EXIT /*6*/:
                return makeFadeAnimation(this.mHost.getContext(), TouchHelperCallback.ALPHA_FULL, 0.0f);
            default:
