...
class SearchViewCompatHoneycomb {
    ...
    static class C01061 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01061(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01072 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01072(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
