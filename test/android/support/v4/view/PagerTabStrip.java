...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mFullUnderlineHeight = (int) ((TouchHelperCallback.ALPHA_FULL * density) + 0.5f);
        ...
        this.mPrevText.setOnClickListener(new C00781());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C00792());
