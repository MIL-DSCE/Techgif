...
public class PhotoCropActivity extends BaseFragment {
    ...
    private class PhotoCropView extends FrameLayout {
        ...
        class C13561 implements OnTouchListener {
            C13561() {
            }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for (int a = PhotoCropActivity.done_button; a < 3; a += PhotoCropActivity.done_button) {
                canvas2 = canvas;
    ...
    class C19041 extends ActionBarMenuOnItemClick {
        ...
        public void onItemClick(int id) {
            ...
            } else if (id == PhotoCropActivity.done_button) {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("CropImage", C0691R.string.CropImage));
