...
public class MenuDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float endYDiff = (((float) AndroidUtilities.dp(5.0f)) * (TouchHelperCallback.ALPHA_FULL - Math.abs(this.currentRotation))) - (((float) AndroidUtilities.dp(0.5f)) * Math.abs(this.currentRotation));
