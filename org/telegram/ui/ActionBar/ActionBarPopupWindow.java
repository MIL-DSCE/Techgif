...
public class ActionBarPopupWindow extends PopupWindow {
    ...
    static class C09031 implements OnScrollChangedListener {
        C09031() {
        }
    ...
    class C09042 implements AnimatorListener {
        C09042() {
        }
    ...
    class C09053 implements AnimatorListener {
        C09053() {
        }
    ...
    public static class ActionBarPopupWindowLayout extends FrameLayout {
        ...
        public ActionBarPopupWindowLayout(Context context) {
            super(context);
            this.backScaleX = TouchHelperCallback.ALPHA_FULL;
            this.backScaleY = TouchHelperCallback.ALPHA_FULL;
            this.backAlpha = NalUnitUtil.EXTENDED_SAR;
            this.lastStartedChild = 0;
            this.positions = new HashMap();
            if (backgroundDrawable == null) {
                backgroundDrawable = getResources().getDrawable(C0691R.drawable.popup_fixed);
            }
        ...
        private void startChildAnimation(View child) {
            if (ActionBarPopupWindow.animationEnabled) {
                ...
                animatorArr[0] = ObjectAnimator.ofFloat(child, "alpha", new float[]{0.0f, TouchHelperCallback.ALPHA_FULL});
        ...
        protected void onDraw(Canvas canvas) {
            if (backgroundDrawable != null) {
                ...
                if (this.showedFromBotton) {
                    backgroundDrawable.setBounds(0, (int) (((float) getMeasuredHeight()) * (TouchHelperCallback.ALPHA_FULL - this.backScaleY)), (int) (((float) getMeasuredWidth()) * this.backScaleX), getMeasuredHeight());
                } else {
    ...
    public void startAnimation() {
        if (animationEnabled && this.windowAnimatorSet == null) {
            ...
            content.setAlpha(TouchHelperCallback.ALPHA_FULL);
            ...
            this.windowAnimatorSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(content, "backScaleY", new float[]{0.0f, TouchHelperCallback.ALPHA_FULL}), ObjectAnimator.ofInt(content, "backAlpha", new int[]{0, NalUnitUtil.EXTENDED_SAR})});
            this.windowAnimatorSet.setDuration((long) ((visibleCount * 16) + 150));
            this.windowAnimatorSet.addListener(new C09042());
    ...
    public void dismiss(boolean animated) {
        ...
        if (animationEnabled && animated) {
            ...
            this.windowAnimatorSet.addListener(new C09053());
            this.windowAnimatorSet.start();
            return;
        }
        try {
