...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    class C09141 implements OnApplyWindowInsetsListener {
        C09141() {
        }
    ...
    class C17472 extends AnimatorListenerAdapterProxy {
        C17472() {
        }
    ...
    class C17483 extends AnimatorListenerAdapterProxy {
        C17483() {
        }
    ...
    public DrawerLayoutContainer(Context context) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            setOnApplyWindowInsetsListener(new C09141());
            setSystemUiVisibility(1280);
        }
        this.shadowLeft = getResources().getDrawable(C0691R.drawable.menu_shadow);
    }
    ...
    public void openDrawer(boolean fast) {
        if (this.allowOpenDrawer) {
            ...
            animatorSet.addListener(new C17472());
            animatorSet.start();
    ...
    public void closeDrawer(boolean fast) {
        ...
        animatorSet.addListener(new C17483());
        animatorSet.start();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (this.drawerLayout != child) {
                    child.measure(MeasureSpec.makeMeasureSpec((widthSize - lp.leftMargin) - lp.rightMargin, C0747C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec((heightSize - lp.topMargin) - lp.bottomMargin, C0747C.ENCODING_PCM_32BIT));
                } else {
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (this.scrimOpacity <= 0.0f || !drawingContent) {
            ...
            float alpha = Math.max(0.0f, Math.min(this.drawerPosition / ((float) AndroidUtilities.dp(20.0f)), TouchHelperCallback.ALPHA_FULL));
            if (alpha == 0.0f) {
                return result;
            }
