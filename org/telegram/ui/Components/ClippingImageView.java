    ...
    public void onDraw(Canvas canvas) {
        if (getVisibility() == 0 && this.bmp != null) {
            ...
            if (this.needRadius) {
                ...
                float scaleW = getWidth() != 0 ? (float) (bitmapW / getWidth()) : TouchHelperCallback.ALPHA_FULL;
                float scaleH = getHeight() != 0 ? (float) (bitmapH / getHeight()) : TouchHelperCallback.ALPHA_FULL;
