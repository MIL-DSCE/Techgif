...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        this.cancelButton.setBackgroundDrawable(Theme.createBarSelectorDrawable(this.isDarkTheme ? Theme.ACTION_BAR_PICKER_SELECTOR_COLOR : Theme.ACTION_BAR_AUDIO_SELECTOR_COLOR, false));
        this.cancelButton.setPadding(AndroidUtilities.dp(29.0f), 0, AndroidUtilities.dp(29.0f), 0);
        this.cancelButton.setText(LocaleController.getString("Cancel", C0691R.string.Cancel).toUpperCase());
        ...
        this.doneButton.setBackgroundDrawable(Theme.createBarSelectorDrawable(this.isDarkTheme ? Theme.ACTION_BAR_PICKER_SELECTOR_COLOR : Theme.ACTION_BAR_AUDIO_SELECTOR_COLOR, false));
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C0691R.drawable.photobadge : C0691R.drawable.bluecounter);
