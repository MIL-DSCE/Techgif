...
public class PasscodeView extends FrameLayout {
    ...
    class C11391 implements OnEditorActionListener {
        C11391() {
        }
    ...
    class C11402 implements TextWatcher {
        C11402() {
        }
    ...
    class C11413 implements Callback {
        C11413() {
        }
    ...
    class C11424 implements OnClickListener {
        C11424() {
        }
    ...
    class C11435 implements OnLongClickListener {
        C11435() {
        }
    ...
    class C11446 implements OnClickListener {
        C11446() {
        }
    ...
    class C11459 implements Runnable {
        C11459() {
        }
    ...
    private class AnimatingTextView extends FrameLayout {
        ...
        class C11461 implements Runnable {
            ...
            class C18271 extends AnimatorListenerAdapterProxy {
                C18271() {
                }
            ...
            public void run() {
                if (AnimatingTextView.this.dotRunnable == this) {
                    ...
                    animators.add(ObjectAnimator.ofFloat(textView, "scaleX", new float[]{TouchHelperCallback.ALPHA_FULL}));
                    animators.add(ObjectAnimator.ofFloat(textView, "scaleY", new float[]{TouchHelperCallback.ALPHA_FULL}));
                    animators.add(ObjectAnimator.ofFloat(textView, "alpha", new float[]{TouchHelperCallback.ALPHA_FULL}));
                    ...
                    AnimatingTextView.this.currentAnimation.addListener(new C18271());
        ...
        class C18282 extends AnimatorListenerAdapterProxy {
            C18282() {
            }
        ...
        class C18293 extends AnimatorListenerAdapterProxy {
            C18293() {
            }
        ...
        class C18304 extends AnimatorListenerAdapterProxy {
            C18304() {
            }
        ...
        public void appendCharacter(String c) {
            if (this.stringBuilder.length() != 4) {
                ...
                ArrayList<Animator> animators = new ArrayList();
                int newPos = this.stringBuilder.length();
                this.stringBuilder.append(c);
                TextView textView = (TextView) this.characterTextViews.get(newPos);
                textView.setText(c);
                textView.setTranslationX((float) getXForTextView(newPos));
                animators.add(ObjectAnimator.ofFloat(textView, "scaleX", new float[]{0.0f, TouchHelperCallback.ALPHA_FULL}));
                animators.add(ObjectAnimator.ofFloat(textView, "scaleY", new float[]{0.0f, TouchHelperCallback.ALPHA_FULL}));
                animators.add(ObjectAnimator.ofFloat(textView, "alpha", new float[]{0.0f, TouchHelperCallback.ALPHA_FULL}));
                ...
                this.dotRunnable = new C11461(newPos);
                ...
                this.currentAnimation.addListener(new C18282());
        ...
        public void eraseLastCharacter() {
            if (this.stringBuilder.length() != 0) {
                ...
                this.currentAnimation.setDuration(150);
                this.currentAnimation.playTogether(animators);
                this.currentAnimation.addListener(new C18293());
                this.currentAnimation.start();
            }
        }
        ...
        private void eraseAllCharacters(boolean animated) {
            if (this.stringBuilder.length() != 0) {
                ...
                if (animated) {
                    ...
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.playTogether(animators);
                    this.currentAnimation.addListener(new C18304());
                    this.currentAnimation.start();
                    return;
                }
                for (a = 0; a < 4; a++) {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            for (int a = 0; a < 4; a++) {
                if (a < this.stringBuilder.length()) {
                    TextView textView = (TextView) this.characterTextViews.get(a);
                    textView.setAlpha(0.0f);
                    textView.setScaleX(TouchHelperCallback.ALPHA_FULL);
                    textView.setScaleY(TouchHelperCallback.ALPHA_FULL);
                    textView.setTranslationY(0.0f);
                    textView.setTranslationX((float) getXForTextView(a));
                    textView = (TextView) this.dotTextViews.get(a);
                    textView.setAlpha(TouchHelperCallback.ALPHA_FULL);
                    textView.setScaleX(TouchHelperCallback.ALPHA_FULL);
                    textView.setScaleY(TouchHelperCallback.ALPHA_FULL);
                    textView.setTranslationY(0.0f);
                    textView.setTranslationX((float) getXForTextView(a));
    ...
    class C18257 extends AnimatorListenerAdapterProxy {
        C18257() {
        }
    ...
    class C18268 extends AnimatorListenerAdapterProxy {
        final /* synthetic */ int val$num;
        final /* synthetic */ float val$x;

        C18268(int i, float f) {
            this.val$num = i;
            this.val$x = f;
        }
    ...
    public PasscodeView(Context context) {
        ...
        imageView.setImageResource(C0691R.drawable.passcode_logo);
        ...
        this.passwordEditText.setOnEditorActionListener(new C11391());
        this.passwordEditText.addTextChangedListener(new C11402());
        this.passwordEditText.setCustomSelectionActionModeCallback(new C11413());
        this.checkImage = new ImageView(context);
        this.checkImage.setImageResource(C0691R.drawable.passcode_check);
        this.checkImage.setScaleType(ScaleType.CENTER);
        this.checkImage.setBackgroundResource(C0691R.drawable.bar_selector_lock);
        ...
        this.checkImage.setOnClickListener(new C11424());
        ...
        layoutParams.width = -1;
        layoutParams.height = AndroidUtilities.dp(TouchHelperCallback.ALPHA_FULL);
        ...
        this.eraseView.setImageResource(C0691R.drawable.passcode_delete);
        ...
        for (a = 0; a < 11; a++) {
            ...
            frameLayout.setBackgroundResource(C0691R.drawable.bar_selector_lock);
            frameLayout.setTag(Integer.valueOf(a));
            if (a == 10) {
                frameLayout.setOnLongClickListener(new C11435());
            }
            frameLayout.setOnClickListener(new C11446());
    ...
    private void processDone(boolean fingerprint) {
        ...
        AnimatorSet.addListener(new C18257());
        AnimatorSet.start();
    ...
    private void shakeTextView(float x, int num) {
        if (num != 6) {
            AnimatorSet AnimatorSet = new AnimatorSet();
            ...
            AnimatorSet.addListener(new C18268(num, x));
            AnimatorSet.start();
        }
    }
    ...
    public void onResume() {
        if (UserConfig.passcodeType == 1) {
            ...
            AndroidUtilities.runOnUIThread(new C11459(), 200);
        }
        checkFingerprint();
    }
        ...
        if (VERSION.SDK_INT >= 23 && parentActivity != null && UserConfig.useFingerprint && !ApplicationLoader.mainInterfacePaused) {
            ...
            try {
                ...
                if (fingerprintManager.isHardwareDetected() && fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    fingerprintTextView.setText(LocaleController.getString("FingerprintInfo", C0691R.string.FingerprintInfo));
                    ...
                    this.fingerprintImageView.setImageResource(C0691R.drawable.ic_fp_40px);
                    this.fingerprintImageView.setId(id_fingerprint_imageview);
                    View view = this.fingerprintImageView;
                    relativeLayout.addView(r18, LayoutHelper.createRelative(-2.0f, -2.0f, 0, 20, 0, 0, 20, 3, id_fingerprint_textview));
                    this.fingerprintStatusTextView = new TextView(getContext());
                    this.fingerprintStatusTextView.setGravity(16);
                    this.fingerprintStatusTextView.setText(LocaleController.getString("FingerprintHelp", C0691R.string.FingerprintHelp));
                    ...
                    fingerprintManager.authenticate(null, 0, this.cancellationSignal, new AuthenticationCallback() {
                        ...
                        public void onAuthenticationFailed() {
                            PasscodeView.this.showFingerprintError(LocaleController.getString("FingerprintNotRecognized", C0691R.string.FingerprintNotRecognized));
                        }
    ...
    public void onShow() {
        ...
        if (getVisibility() != 0) {
            ...
            this.passcodeTextView.setText(LocaleController.getString("EnterYourPasscode", C0691R.string.EnterYourPasscode));
            if (UserConfig.passcodeType == 0) {
    ...
    private void showFingerprintError(CharSequence error) {
        this.fingerprintImageView.setImageResource(C0691R.drawable.ic_fingerprint_error);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int sizeBetweenNumbersX;
        int sizeBetweenNumbersY;
        int a;
        int num;
        int row;
        int col;
        ...
        if (!AndroidUtilities.isTablet()) {
            ...
            if (r0 == 2) {
                ...
                this.numbersFrameLayout.setLayoutParams(layoutParams);
                sizeBetweenNumbersX = (layoutParams.width - (AndroidUtilities.dp(50.0f) * 3)) / 4;
                sizeBetweenNumbersY = (layoutParams.height - (AndroidUtilities.dp(50.0f) * 4)) / 5;
                for (a = 0; a < 11; a++) {
                    if (a == 0) {
                        num = 10;
                    } else if (a != 10) {
        ...
        for (a = 0; a < 11; a++) {
            ...
            if (a >= 10) {
                ...
                TextView textView2 = (TextView) this.numberTextViews.get(a);
                TextView textView12 = (TextView) this.lettersTextViews.get(a);
                layoutParams = (LayoutParams) textView2.getLayoutParams();
                layoutParams1 = (LayoutParams) textView12.getLayoutParams();
                top = sizeBetweenNumbersY + ((AndroidUtilities.dp(50.0f) + sizeBetweenNumbersY) * row);
                layoutParams.topMargin = top;
                layoutParams1.topMargin = top;
                i = ((AndroidUtilities.dp(50.0f) + sizeBetweenNumbersX) * col) + sizeBetweenNumbersX;
            ...
            FrameLayout frameLayout2 = (FrameLayout) this.numberFrameLayouts.get(a);
            layoutParams1 = (LayoutParams) frameLayout2.getLayoutParams();
            layoutParams1.topMargin = top - AndroidUtilities.dp(17.0f);
            layoutParams1.leftMargin = layoutParams.leftMargin - AndroidUtilities.dp(25.0f);
            frameLayout2.setLayoutParams(layoutParams1);
        }
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    }
