...
public class WallpapersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C14842 implements OnTouchListener {
        C14842() {
        }
    ...
    class C19601 extends ActionBarMenuOnItemClick {
        ...
        public void onItemClick(int id) {
            if (id == -1) {
            ...
            } else if (id == WallpapersActivity.done_button) {
                boolean done;
                ...
                if (wallPaper != null && wallPaper.id != 1000001 && (wallPaper instanceof TL_wallPaper)) {
                    ...
                    long j = size.location.volume_id;
                    try {
                        done = AndroidUtilities.copyFile(new File(FileLoader.getInstance().getDirectory(4), r0 + "_" + size.location.local_id + ".jpg"), new File(ApplicationLoader.getFilesDirFixed(), "wallpaper.jpg"));
                    } catch (Throwable e) {
                        done = false;
    ...
    class C19613 implements OnItemClickListener {

        /* renamed from: org.telegram.ui.WallpapersActivity.3.1 */
        ...
        public void onItemClick(View view, int position) {
            if (position == 0) {
                if (WallpapersActivity.this.getParentActivity() != null) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString("FromCamera", C0691R.string.FromCamera), LocaleController.getString("FromGalley", C0691R.string.FromGalley), LocaleController.getString("Cancel", C0691R.string.Cancel)}, new C14851());
    ...
    class C19624 implements RequestDelegate {

        /* renamed from: org.telegram.ui.WallpapersActivity.4.1 */
        class C14861 implements Runnable {
            final /* synthetic */ TLObject val$response;

            C14861(TLObject tLObject) {
                this.val$response = tLObject;
            }

            public void run() {
                WallpapersActivity.this.wallPapers.clear();
                Vector res = this.val$response;
        ...
        public void run(TLObject response, TL_error error) {
            if (error == null) {
                AndroidUtilities.runOnUIThread(new C14861(response));
            }
        }
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("ChatBackground", C0691R.string.ChatBackground));
        ...
        this.backgroundImage.setOnTouchListener(new C14842());
        this.progressView = new FrameLayout(context);
        this.progressView.setVisibility(4);
        frameLayout.addView(this.progressView, LayoutHelper.createFrame(-1, GroundOverlayOptions.NO_DIMENSION, 51, 0.0f, 0.0f, 0.0f, 52.0f));
        this.progressViewBackground = new View(context);
        this.progressViewBackground.setBackgroundResource(C0691R.drawable.system_loader);
        this.progressView.addView(this.progressViewBackground, LayoutHelper.createFrame(36, 36, 17));
        ProgressBar progressBar = new ProgressBar(context);
        try {
            progressBar.setIndeterminateDrawable(context.getResources().getDrawable(C0691R.drawable.loading_animation));
        } catch (Exception e) {
        }
        ...
        listView.setOnItemClickListener(new C19613());
    ...
    private void processSelectedBackground() {
        ...
        if (this.selectedBackground == -1 || this.selectedBackground == 1000001 || wallPaper == null || !(wallPaper instanceof TL_wallPaper)) {
            ...
            if (this.selectedBackground == 1000001) {
                this.backgroundImage.setImageResource(C0691R.drawable.background_hd);
    ...
    private void loadWallpapers() {
        ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(new TL_account_getWallPapers(), new C19624()), this.classGuid);
    }
