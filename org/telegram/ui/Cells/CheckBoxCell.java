...
public class CheckBoxCell extends FrameLayout {
    ...
    public CheckBoxCell(Context context) {
        ...
        addView(view, LayoutHelper.createFrame(-1, GroundOverlayOptions.NO_DIMENSION, i | 48, (float) (LocaleController.isRTL ? 17 : 46), 0.0f, (float) (LocaleController.isRTL ? 46 : 17), 0.0f));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.valueTextView.measure(MeasureSpec.makeMeasureSpec(availableWidth / 2, LinearLayoutManager.INVALID_OFFSET), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), C0747C.ENCODING_PCM_32BIT));
        this.textView.measure(MeasureSpec.makeMeasureSpec((availableWidth - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.dp(8.0f), C0747C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), C0747C.ENCODING_PCM_32BIT));
        this.checkBox.measure(MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(18.0f), LinearLayoutManager.INVALID_OFFSET), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(18.0f), C0747C.ENCODING_PCM_32BIT));
    }
