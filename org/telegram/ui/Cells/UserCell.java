...
public class UserCell extends FrameLayout {
    ...
    public void setIsAdmin(int value) {
        if (this.adminImage != null) {
            ...
            if (value == 1) {
                this.adminImage.setImageResource(C0691R.drawable.admin_star);
            } else if (value == 2) {
                this.adminImage.setImageResource(C0691R.drawable.admin_star2);
            }
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), C0747C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f), C0747C.ENCODING_PCM_32BIT));
    }
            ...
            if (this.currrntStatus != null) {
                ...
                if (currentUser.bot) {
                    ...
                    if (currentUser.bot_chat_history || (this.adminImage != null && this.adminImage.getVisibility() == 0)) {
                        this.statusTextView.setText(LocaleController.getString("BotStatusRead", C0691R.string.BotStatusRead));
                    } else {
                        this.statusTextView.setText(LocaleController.getString("BotStatusCantRead", C0691R.string.BotStatusCantRead));
                    }
                    ...
                    this.statusTextView.setText(LocaleController.getString("Online", C0691R.string.Online));
                } else {
                    this.statusTextView.setTextColor(this.statusColor);
