...
public class TextCheckCell extends FrameLayout {
    ...
    public TextCheckCell(Context context) {
        ...
        addView(this.textView, LayoutHelper.createFrame(-1, GroundOverlayOptions.NO_DIMENSION, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 64.0f : 17.0f, 0.0f, LocaleController.isRTL ? 17.0f : 64.0f, 0.0f));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec((this.needDivider ? 1 : 0) + AndroidUtilities.dp(this.valueTextView.getVisibility() == 0 ? 64.0f : 48.0f), C0747C.ENCODING_PCM_32BIT));
    }
