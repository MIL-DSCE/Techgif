...
public class RadioCell extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.radioButton.measure(MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(22.0f), LinearLayoutManager.INVALID_OFFSET), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(22.0f), C0747C.ENCODING_PCM_32BIT));
        this.textView.measure(MeasureSpec.makeMeasureSpec(availableWidth, C0747C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), C0747C.ENCODING_PCM_32BIT));
    }
