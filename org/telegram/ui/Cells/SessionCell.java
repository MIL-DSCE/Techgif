...
public class SessionCell extends FrameLayout {
    ...
    public SessionCell(Context context) {
        ...
        linearLayout.setWeightSum(TouchHelperCallback.ALPHA_FULL);
        ...
        if (LocaleController.isRTL) {
            ...
            linearLayout.addView(this.nameTextView, LayoutHelper.createLinear(0, -1, TouchHelperCallback.ALPHA_FULL, 53, 10, 0, 0, 0));
        } else {
            linearLayout.addView(this.nameTextView, LayoutHelper.createLinear(0, -1, TouchHelperCallback.ALPHA_FULL, 51, 0, 0, 10, 0));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec((this.needDivider ? 1 : 0) + AndroidUtilities.dp(90.0f), C0747C.ENCODING_PCM_32BIT));
    }
    ...
    public void setSession(TL_authorization session, boolean divider) {
        ...
        if ((session.flags & 2) == 0) {
            ...
            stringBuilder.append(LocaleController.getString("UnofficialApp", C0691R.string.UnofficialApp));
