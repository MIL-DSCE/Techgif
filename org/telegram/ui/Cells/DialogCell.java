...
public class DialogCell extends BaseCell {
    ...
    public DialogCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            lockDrawable = getResources().getDrawable(C0691R.drawable.list_secret);
            checkDrawable = getResources().getDrawable(C0691R.drawable.dialogs_check);
            halfCheckDrawable = getResources().getDrawable(C0691R.drawable.dialogs_halfcheck);
            clockDrawable = getResources().getDrawable(C0691R.drawable.msg_clock);
            errorDrawable = getResources().getDrawable(C0691R.drawable.dialogs_warning);
            countDrawable = getResources().getDrawable(C0691R.drawable.dialogs_badge);
            countDrawableGrey = getResources().getDrawable(C0691R.drawable.dialogs_badge2);
            groupDrawable = getResources().getDrawable(C0691R.drawable.list_group);
            broadcastDrawable = getResources().getDrawable(C0691R.drawable.list_broadcast);
            muteDrawable = getResources().getDrawable(C0691R.drawable.mute_grey);
            verifiedDrawable = getResources().getDrawable(C0691R.drawable.check_list);
            botDrawable = getResources().getDrawable(C0691R.drawable.bot_list);
        }
    ...
    public void buildLayout() {
        ...
        if (printingString != null) {
            ...
            if (this.draftMessage != null) {
                ...
                if (TextUtils.isEmpty(this.draftMessage.message)) {
                    draftString = LocaleController.getString("Draft", C0691R.string.Draft);
                    ...
                    stringBuilder = SpannableStringBuilder.valueOf(String.format("%s: %s", new Object[]{LocaleController.getString("Draft", C0691R.string.Draft), mess.replace('\n', ' ')}));
                ...
                if (this.message.messageOwner instanceof TL_messageService) {
                    ...
                    if (this.message.isOutOwner()) {
                        name = LocaleController.getString("FromYou", C0691R.string.FromYou);
                    ...
                    if (this.message.caption != null) {
                        ...
                        stringBuilder.setSpan(new ForegroundColorSpan(Theme.DIALOGS_ATTACH_TEXT_COLOR), name.length() + 2, stringBuilder.length(), 33);
                    ...
                    if (stringBuilder.length() > 0) {
                        stringBuilder.setSpan(new ForegroundColorSpan(Theme.DIALOGS_NAME_TEXT_COLOR), 0, name.length() + 1, 33);
                    }
                    messageString = Emoji.replaceEmoji(stringBuilder, messagePaint.getFontMetricsInt(), AndroidUtilities.dp(20.0f), false);
                ...
                if (this.encryptedChat instanceof TL_encryptedChatRequested) {
                    messageString = LocaleController.getString("EncryptionProcessing", C0691R.string.EncryptionProcessing);
                } else if (this.encryptedChat instanceof TL_encryptedChatWaiting) {
                    messageString = (this.user == null || this.user.first_name == null) ? LocaleController.formatString("AwaitingEncryption", C0691R.string.AwaitingEncryption, TtmlNode.ANONYMOUS_REGION_ID) : LocaleController.formatString("AwaitingEncryption", C0691R.string.AwaitingEncryption, this.user.first_name);
                } else if (this.encryptedChat instanceof TL_encryptedChatDiscarded) {
                    messageString = LocaleController.getString("EncryptionRejected", C0691R.string.EncryptionRejected);
                } else if (this.encryptedChat instanceof TL_encryptedChat) {
                    messageString = this.encryptedChat.admin_id == UserConfig.getClientUserId() ? (this.user == null || this.user.first_name == null) ? LocaleController.formatString("EncryptedChatStartedOutgoing", C0691R.string.EncryptedChatStartedOutgoing, TtmlNode.ANONYMOUS_REGION_ID) : LocaleController.formatString("EncryptedChatStartedOutgoing", C0691R.string.EncryptedChatStartedOutgoing, this.user.first_name) : LocaleController.getString("EncryptedChatStartedIncoming", C0691R.string.EncryptedChatStartedIncoming);
                }
            }
        }
        if (this.draftMessage != null) {
        ...
        if (nameString.length() == 0) {
            nameString = LocaleController.getString("HiddenName", C0691R.string.HiddenName);
        }
        if (LocaleController.isRTL) {
    ...
    public void update(int mask) {
        ...
        if (mask != 0) {
            ...
            if (!(continueUpdate || (mask & MessagesController.UPDATE_MASK_SEND_STATE) == 0 || this.message == null || this.lastSendState == this.message.messageOwner.send_state)) {
                this.lastSendState = this.message.messageOwner.send_state;
                continueUpdate = true;
            }
            if (!continueUpdate) {
