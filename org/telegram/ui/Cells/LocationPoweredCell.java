...
public class LocationPoweredCell extends FrameLayout {
    public LocationPoweredCell(Context context) {
        ...
        imageView.setImageResource(C0691R.drawable.foursquare);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(56.0f), C0747C.ENCODING_PCM_32BIT));
    }
}
