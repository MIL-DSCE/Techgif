...
public class SharedDocumentCell extends FrameLayout implements FileDownloadProgressListener {
    ...
    class C17651 implements ImageReceiverDelegate {
        C17651() {
        }
    ...
    public SharedDocumentCell(Context context) {
        ...
        float f2;
        super(context);
        this.icons = new int[]{C0691R.drawable.media_doc_blue, C0691R.drawable.media_doc_green, C0691R.drawable.media_doc_red, C0691R.drawable.media_doc_yellow};
        if (paint == null) {
            paint = new Paint();
        ...
        addView(view, LayoutHelper.createFrame(40, 40.0f, i, f, 8.0f, f2, 0.0f));
        this.thumbImageView.getImageReceiver().setDelegate(new C17651());
    ...
    public void setDocument(MessageObject messageObject, boolean divider) {
        ...
        if (messageObject == null || messageObject.getDocument() == null) {
            ...
            objArr2[0] = LocaleController.getInstance().formatterYear.format(new Date(date));
            objArr2[1] = LocaleController.getInstance().formatterDay.format(new Date(date));
            objArr[1] = LocaleController.formatString("formatDateAtTime", C0691R.string.formatDateAtTime, objArr2);
    ...
    public void updateFileExistIcon() {
        ...
        this.statusImageView.setImageResource(this.loading ? C0691R.drawable.media_doc_pause : C0691R.drawable.media_doc_load);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec((this.needDivider ? 1 : 0) + AndroidUtilities.dp(56.0f), C0747C.ENCODING_PCM_32BIT));
    }
    ...
    public void onSuccessDownload(String name) {
        this.progressView.setProgress(TouchHelperCallback.ALPHA_FULL, true);
        updateFileExistIcon();
    }
