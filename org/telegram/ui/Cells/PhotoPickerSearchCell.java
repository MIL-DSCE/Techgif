...
public class PhotoPickerSearchCell extends LinearLayout {
    ...
    class C09881 implements OnClickListener {
        C09881() {
        }
    ...
    class C09892 implements OnClickListener {
        C09892() {
        }
    ...
    public PhotoPickerSearchCell(Context context, boolean allowGifs) {
        ...
        searchButton.textView1.setText(LocaleController.getString("SearchImages", C0691R.string.SearchImages));
        searchButton.textView2.setText(LocaleController.getString("SearchImagesInfo", C0691R.string.SearchImagesInfo));
        searchButton.imageView.setImageResource(C0691R.drawable.search_web);
        ...
        searchButton.setOnClickListener(new C09881());
        ...
        searchButton.textView1.setText(LocaleController.getString("SearchGifs", C0691R.string.SearchGifs));
        searchButton.textView2.setText("GIPHY");
        searchButton.imageView.setImageResource(C0691R.drawable.search_gif);
        addView(searchButton);
        ...
        searchButton.setLayoutParams(layoutParams);
        if (allowGifs) {
            searchButton.setOnClickListener(new C09892());
        } else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(52.0f), C0747C.ENCODING_PCM_32BIT));
    }
}
