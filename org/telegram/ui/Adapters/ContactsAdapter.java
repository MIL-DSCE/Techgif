...
public class ContactsAdapter extends BaseSectionsAdapter {
    ...
    public View getSectionHeaderView(int section, View convertView, ViewGroup parent) {
        ...
        if (this.onlyUsers == 0 || this.isAdmin) {
            if (section == 0) {
                ((LetterSectionCell) convertView).setLetter(TtmlNode.ANONYMOUS_REGION_ID);
            } else if (section - 1 < sortedUsersSectionsArray.size()) {
    ...
    public View getItemView(int section, int position, View convertView, ViewGroup parent) {
        ...
        if (type == 4) {
            ...
            ((GreySectionCell) convertView).setText(LocaleController.getString("Contacts", C0691R.string.Contacts).toUpperCase());
            return convertView;
        } else if (type == 2) {
            if (convertView == null) {
            ...
            if (this.needPhonebook) {
                ...
                actionCell.setTextAndIcon(LocaleController.getString("InviteToGroupByLink", C0691R.string.InviteToGroupByLink), C0691R.drawable.menu_invite);
                return convertView;
            } else if (position == 0) {
            ...
            convertView.setAlpha(TouchHelperCallback.ALPHA_FULL);
            return convertView;
        }
    }
