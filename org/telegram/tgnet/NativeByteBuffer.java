...
public class NativeByteBuffer extends AbstractSerializedData {
    ...
    static class C08831 extends ThreadLocal<NativeByteBuffer> {
        C08831() {
        }
    ...
    public static NativeByteBuffer wrap(int address) {
        ...
        if (address != 0) {
            if (!result.reused) {
                FileLog.m11e("tmessages", "forgot to reuse?");
            }
    ...
    public void writeInt32(int x) {
        try {
            ...
            FileLog.m11e("tmessages", "write int32 error");
        }
    }
    ...
    public void writeInt64(long x) {
        try {
            ...
            FileLog.m11e("tmessages", "write int64 error");
        }
    }
    ...
    public void writeBytes(byte[] b) {
        try {
            ...
            FileLog.m11e("tmessages", "write raw error");
        }
    }
    ...
    public void writeByte(byte b) {
        try {
            ...
            FileLog.m11e("tmessages", "write byte error");
        }
    }

    public void writeString(String s) {
        try {
            writeByteArray(s.getBytes(C0747C.UTF8_NAME));
        } catch (Exception e) {
            FileLog.m11e("tmessages", "write string error");
        }
    }
    ...
    public void writeByteArray(byte[] b, int offset, int count) {
        if (count <= 253) {
            try {
                ...
                FileLog.m11e("tmessages", "write byte array error");
                return;
            }
    ...
    public void writeDouble(double d) {
        try {
            ...
            FileLog.m11e("tmessages", "write double error");
        }
    }
    ...
    public int getIntFromByte(byte b) {
        return b >= null ? b : b + MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE;
    }
    ...
    public int readInt32(boolean exception) {
        try {
            ...
            FileLog.m11e("tmessages", "read int32 error");
            return 0;
        }
    }
    ...
    public boolean readBool(boolean exception) {
        ...
        FileLog.m11e("tmessages", "Not bool value!");
        return false;
    }
    ...
    public long readInt64(boolean exception) {
        try {
            ...
            FileLog.m11e("tmessages", "read int64 error");
            return 0;
        }
    }
    ...
    public void readBytes(byte[] b, boolean exception) {
        try {
            ...
            FileLog.m11e("tmessages", "read raw error");
        }
    }
    ...
    public String readString(boolean exception) {
        ...
        try {
            ...
            FileLog.m11e("tmessages", "read string error");
            return null;
        }
    }
    ...
    public byte[] readByteArray(boolean exception) {
        ...
        try {
            ...
            FileLog.m11e("tmessages", "read byte array error");
            return null;
        }
    }
    ...
    public double readDouble(boolean exception) {
        try {
            ...
            FileLog.m11e("tmessages", "read double error");
            return 0.0d;
        }
    }
