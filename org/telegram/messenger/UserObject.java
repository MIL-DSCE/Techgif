...
public class UserObject {
    ...
    public static String getUserName(User user) {
        if (user == null || isDeleted(user)) {
            return LocaleController.getString("HiddenName", C0691R.string.HiddenName);
        }
    ...
    public static String getFirstName(User user) {
        ...
        return (name == null || name.length() <= 0) ? LocaleController.getString("HiddenName", C0691R.string.HiddenName) : name;
    }
}
