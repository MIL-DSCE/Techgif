        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_newSession /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg12 = newSession(org.telegram.messenger.support.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case TRANSACTION_mayLaunchUrl /*4*/:
                    ...
                    if (data.readInt() != 0) {
                        _result2 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                        _result2 = null;
                    }
                    boolean _result1 = mayLaunchUrl(_arg0, _arg11, _result2, data.createTypedArrayList(Bundle.CREATOR));
                    reply.writeNoException();
                ...
                case TRANSACTION_extraCommand /*5*/:
                    ...
                    _result2 = extraCommand(_arg01, _arg1);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
