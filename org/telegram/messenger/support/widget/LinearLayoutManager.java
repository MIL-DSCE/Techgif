...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C08551 implements Creator<SavedState> {
            C08551() {
            }
    ...
    /* renamed from: org.telegram.messenger.support.widget.LinearLayoutManager.1 */
    class C20051 extends LinearSmoothScroller {
        C20051(Context x0) {
            super(x0);
        }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int position) {
        LinearSmoothScroller linearSmoothScroller = new C20051(recyclerView.getContext());
    ...
    public void onLayoutChildren(org.telegram.messenger.support.widget.RecyclerView.Recycler r21, org.telegram.messenger.support.widget.RecyclerView.State r22) {
        /*
        r20 = this;
        r0 = r20;
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    int fill(org.telegram.messenger.support.widget.RecyclerView.Recycler r8, org.telegram.messenger.support.widget.LinearLayoutManager.LayoutState r9, org.telegram.messenger.support.widget.RecyclerView.State r10, boolean r11) {
        /*
        r7 = this;
    ...
    L_0x0016:
        ...
        r4 = r9.mExtra;
        r1 = r3 + r4;
        r0 = new org.telegram.messenger.support.widget.LinearLayoutManager$LayoutChunkResult;
        r0.<init>();
    L_0x0021:
        r3 = r9.mInfinite;
    ...
    L_0x007f:
        goto L_0x0037;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.support.widget.LinearLayoutManager.fill(org.telegram.messenger.support.widget.RecyclerView$Recycler, org.telegram.messenger.support.widget.LinearLayoutManager$LayoutState, org.telegram.messenger.support.widget.RecyclerView$State, boolean):int");
    }
    ...
    boolean shouldMeasureTwice() {
        return (getHeightMode() == C0747C.ENCODING_PCM_32BIT || getWidthMode() == C0747C.ENCODING_PCM_32BIT || !hasFlexibleChildInBothOrientations()) ? DEBUG : true;
    }
