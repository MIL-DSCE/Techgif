...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    /* renamed from: org.telegram.messenger.support.widget.helper.ItemTouchHelper.4 */
    class C08644 implements Runnable {
        final /* synthetic */ RecoverAnimation val$anim;
        final /* synthetic */ int val$swipeDir;

        C08644(RecoverAnimation recoverAnimation, int i) {
    ...
    public static abstract class Callback {
        ...
        static class C08651 implements Interpolator {
            C08651() {
            }
        ...
        static class C08662 implements Interpolator {
            C08662() {
            }
        ...
        static {
            sDragScrollInterpolator = new C08651();
            sDragViewScrollCapInterpolator = new C08662();
        ...
        public int interpolateOutOfBoundsScroll(RecyclerView recyclerView, int viewSize, int viewSizeOutOfBounds, int totalSize, long msSinceStartScroll) {
            float timeRatio;
            int cappedScroll = (int) (((float) (((int) Math.signum((float) viewSizeOutOfBounds)) * getMaxDragScroll(recyclerView))) * sDragViewScrollCapInterpolator.getInterpolation(Math.min(TouchHelperCallback.ALPHA_FULL, (TouchHelperCallback.ALPHA_FULL * ((float) Math.abs(viewSizeOutOfBounds))) / ((float) viewSize))));
            if (msSinceStartScroll > DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS) {
                timeRatio = TouchHelperCallback.ALPHA_FULL;
            } else {
    ...
    class C17322 implements OnItemTouchListener {
        C17322() {
        }
    ...
    class C17335 implements ChildDrawingOrderCallback {
        C17335() {
        }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C17341 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C17341(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C17341(ItemTouchHelper.this));
        ...
        public void onAnimationCancel(ValueAnimatorCompat animation) {
            setFraction(TouchHelperCallback.ALPHA_FULL);
        }
    ...
    /* renamed from: org.telegram.messenger.support.widget.helper.ItemTouchHelper.3 */
    class C20073 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C20073(ViewHolder x0, int x1, int x2, float x3, float x4, float x5, float x6, int i, ViewHolder viewHolder) {
            this.val$swipeDir = i;
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    RecoverAnimation rv = new C20073(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY, swipeDir, prevSelected);
    ...
    private void postDispatchSwipe(RecoverAnimation anim, int swipeDir) {
        this.mRecyclerView.post(new C08644(anim, swipeDir));
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C17335();
            }
