...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    /* renamed from: org.telegram.messenger.support.widget.DefaultItemAnimator.1 */
    class C08521 implements Runnable {
        final /* synthetic */ ArrayList val$moves;

        C08521(ArrayList arrayList) {
    ...
    /* renamed from: org.telegram.messenger.support.widget.DefaultItemAnimator.2 */
    class C08532 implements Runnable {
        final /* synthetic */ ArrayList val$changes;

        C08532(ArrayList arrayList) {
    ...
    /* renamed from: org.telegram.messenger.support.widget.DefaultItemAnimator.3 */
    class C08543 implements Runnable {
        final /* synthetic */ ArrayList val$additions;

        C08543(ArrayList arrayList) {
    ...
    /* renamed from: org.telegram.messenger.support.widget.DefaultItemAnimator.4 */
    class C20004 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C20004(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
        ...
        public void onAnimationEnd(View view) {
            ...
            ViewCompat.setAlpha(view, TouchHelperCallback.ALPHA_FULL);
    ...
    /* renamed from: org.telegram.messenger.support.widget.DefaultItemAnimator.5 */
    class C20015 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C20015(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$animation = viewPropertyAnimatorCompat;
            super();
        }
    ...
    /* renamed from: org.telegram.messenger.support.widget.DefaultItemAnimator.6 */
    class C20026 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ int val$deltaX;
        final /* synthetic */ int val$deltaY;
        final /* synthetic */ ViewHolder val$holder;

        C20026(ViewHolder viewHolder, int i, int i2, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$deltaX = i;
            this.val$deltaY = i2;
            this.val$animation = viewPropertyAnimatorCompat;
    ...
    /* renamed from: org.telegram.messenger.support.widget.DefaultItemAnimator.7 */
    class C20037 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ ViewPropertyAnimatorCompat val$oldViewAnim;

        C20037(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    /* renamed from: org.telegram.messenger.support.widget.DefaultItemAnimator.8 */
    class C20048 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ View val$newView;
        final /* synthetic */ ViewPropertyAnimatorCompat val$newViewAnimation;

        C20048(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view) {
            this.val$changeInfo = changeInfo;
        ...
        public void onAnimationEnd(View view) {
            ...
            ViewCompat.setAlpha(this.val$newView, TouchHelperCallback.ALPHA_FULL);
    ...
    public void runPendingAnimations() {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (movesPending) {
                ...
                Runnable c08521 = new C08521(moves);
                if (removalsPending) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) moves.get(0)).holder.itemView, c08521, getRemoveDuration());
                } else {
                    c08521.run();
                }
            }
            if (changesPending) {
                ...
                Runnable changer = new C08532(changes);
                if (removalsPending) {
            ...
            if (additionsPending) {
                ...
                Runnable adder = new C08543(additions);
    ...
    private void animateRemoveImpl(ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new C20004(holder, animation)).start();
    }
    ...
    private void animateAddImpl(ViewHolder holder) {
        ...
        animation.alpha(TouchHelperCallback.ALPHA_FULL).setDuration(getAddDuration()).setListener(new C20015(holder, animation)).start();
    }
    ...
    private void animateMoveImpl(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new C20026(holder, deltaX, deltaY, animation)).start();
    }
    ...
    private void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0.0f).setListener(new C20037(changeInfo, oldViewAnim)).start();
        }
        if (newView != null) {
            ViewPropertyAnimatorCompat newViewAnimation = ViewCompat.animate(newView);
            this.mChangeAnimations.add(changeInfo.newHolder);
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(TouchHelperCallback.ALPHA_FULL).setListener(new C20048(changeInfo, newViewAnimation, newView)).start();
        }
    }
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder item) {
        ...
        ViewCompat.setAlpha(item.itemView, TouchHelperCallback.ALPHA_FULL);
    ...
    public void endAnimations() {
        ...
        for (i = this.mPendingAdditions.size() - 1; i >= 0; i--) {
            ...
            ViewCompat.setAlpha(item2.itemView, TouchHelperCallback.ALPHA_FULL);
