...
final class TtmlNode {
    ...
    public List<Cue> getCues(long timeUs, Map<String, TtmlStyle> globalStyles, Map<String, TtmlRegion> regionMap) {
        ...
        for (Entry<String, SpannableStringBuilder> entry : regionOutputs.entrySet()) {
            ...
            cues.add(new Cue(cleanUpText((SpannableStringBuilder) entry.getValue()), null, region.line, LinearLayoutManager.INVALID_OFFSET, LinearLayoutManager.INVALID_OFFSET, region.position, LinearLayoutManager.INVALID_OFFSET, region.width));
        }
        return cues;
    }
