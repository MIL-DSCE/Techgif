...
final class WavHeader {
    ...
    public long getDurationUs() {
        return (C0747C.MICROS_PER_SECOND * (this.dataSize / ((long) this.blockAlignment))) / ((long) this.sampleRateHz);
    }
    ...
    public long getPosition(long timeUs) {
        return ((((((long) this.averageBytesPerSecond) * timeUs) / C0747C.MICROS_PER_SECOND) / ((long) this.blockAlignment)) * ((long) this.blockAlignment)) + this.dataStartPosition;
    }

    public long getTimeUs(long position) {
        return (C0747C.MICROS_PER_SECOND * position) / ((long) this.averageBytesPerSecond);
    }
