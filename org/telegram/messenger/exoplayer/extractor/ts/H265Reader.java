...
final class H265Reader extends ElementaryStreamReader {
    ...
    private static final class SampleReader {
        ...
        public void startNalUnit(long position, int offset, int nalUnitType, long pesTimeUs) {
            ...
            if (nalUnitType >= H265Reader.VPS_NUT) {
        ...
        public void readNalUnitData(byte[] data, int offset, int limit) {
            if (this.lookingForFirstSliceFlag) {
                ...
                if (headerOffset < limit) {
                    boolean z;
                    if ((data[headerOffset] & MessagesController.UPDATE_MASK_USER_PHONE) != 0) {
                        z = true;
                    } else {
                        z = false;
                    }
    ...
    public H265Reader(TrackOutput output, SeiReader seiReader) {
        ...
        this.vps = new NalUnitTargetBuffer(VPS_NUT, MessagesController.UPDATE_MASK_USER_PHONE);
        this.sps = new NalUnitTargetBuffer(SPS_NUT, MessagesController.UPDATE_MASK_USER_PHONE);
        this.pps = new NalUnitTargetBuffer(PPS_NUT, MessagesController.UPDATE_MASK_USER_PHONE);
        this.prefixSei = new NalUnitTargetBuffer(PREFIX_SEI_NUT, MessagesController.UPDATE_MASK_USER_PHONE);
        this.suffixSei = new NalUnitTargetBuffer(SUFFIX_SEI_NUT, MessagesController.UPDATE_MASK_USER_PHONE);
