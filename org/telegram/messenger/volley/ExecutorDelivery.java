...
public class ExecutorDelivery implements ResponseDelivery {
    ...
    /* renamed from: org.telegram.messenger.volley.ExecutorDelivery.1 */
    class C08691 implements Executor {
        final /* synthetic */ Handler val$handler;

        C08691(Handler handler) {
    ...
    public ExecutorDelivery(Handler handler) {
        this.mResponsePoster = new C08691(handler);
    }
