...
public class BasicNetwork implements Network {
    ...
    static {
        ...
        DEFAULT_POOL_SIZE = MessagesController.UPDATE_MASK_SEND_STATE;
    }
    ...
    public org.telegram.messenger.volley.NetworkResponse performRequest(org.telegram.messenger.volley.Request<?> r27) throws org.telegram.messenger.volley.VolleyError {
        /*
        r26 = this;
    ...
    L_0x0042:
        r3 = new org.telegram.messenger.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x015c, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f6 }
    ...
    L_0x0054:
        ...
        r7 = new org.telegram.messenger.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x015c, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f6 }
    ...
    L_0x00a1:
        r3 = "socket";
        r4 = new org.telegram.messenger.volley.TimeoutError;
        r4.<init>();
        r0 = r27;
    ...
    L_0x00af:
        ...
        goto L_0x0085;
    L_0x00b3:
        r13 = new org.telegram.messenger.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x00a0, ConnectTimeoutException -> 0x0159, MalformedURLException -> 0x0157, IOException -> 0x0155 }
        r17 = 0;
        r4 = android.os.SystemClock.elapsedRealtime();	 Catch:{ SocketTimeoutException -> 0x00a0, ConnectTimeoutException -> 0x0159, MalformedURLException -> 0x0157, IOException -> 0x0155 }
        r18 = r4 - r24;
        r15 = r11;
    ...
    L_0x00fd:
        ...
        r7 = r27.getUrl();
        r4[r5] = r7;
        org.telegram.messenger.volley.VolleyLog.m16e(r3, r4);
        if (r11 == 0) goto L_0x014f;
    L_0x011d:
        r13 = new org.telegram.messenger.volley.NetworkResponse;
        r17 = 0;
    ...
    L_0x0135:
        r3 = "auth";
        r4 = new org.telegram.messenger.volley.AuthFailureError;
        r4.<init>(r13);
        r0 = r27;
        attemptRetryOnException(r3, r0, r4);
        goto L_0x0004;
    L_0x0143:
        r3 = new org.telegram.messenger.volley.NoConnectionError;
        r3.<init>(r2);
        throw r3;
    L_0x0149:
        r3 = new org.telegram.messenger.volley.ServerError;
        r3.<init>(r13);
        throw r3;
    L_0x014f:
        r3 = new org.telegram.messenger.volley.NetworkError;
        r3.<init>(r13);
        throw r3;
    L_0x0155:
        r2 = move-exception;
    ...
    L_0x015c:
        ...
        goto L_0x00a1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.volley.toolbox.BasicNetwork.performRequest(org.telegram.messenger.volley.Request):org.telegram.messenger.volley.NetworkResponse");
    }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            buffer = this.mPool.getBuf(MessagesController.UPDATE_MASK_PHONE);
            while (true) {
