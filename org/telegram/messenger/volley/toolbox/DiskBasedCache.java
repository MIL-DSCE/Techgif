...
public class DiskBasedCache implements Cache {
    ...
    static class CacheHeader {
        ...
        public static CacheHeader readHeader(InputStream is) throws IOException {
            ...
            if (entry.etag.equals(TtmlNode.ANONYMOUS_REGION_ID)) {
                entry.etag = null;
            }
        ...
        public boolean writeHeader(OutputStream os) {
            try {
                ...
                DiskBasedCache.writeString(os, this.etag == null ? TtmlNode.ANONYMOUS_REGION_ID : this.etag);
    ...
    L_0x0011:
        ...
        org.telegram.messenger.volley.VolleyLog.m16e(r9, r10);	 Catch:{ all -> 0x006e }
    L_0x0022:
        monitor-exit(r13);
        return;
    L_0x0024:
    ...
    L_0x0031:
        ...
        r2 = org.telegram.messenger.volley.toolbox.DiskBasedCache.CacheHeader.readHeader(r6);	 Catch:{ IOException -> 0x0076, all -> 0x0073 }
    ...
    L_0x0076:
        ...
        goto L_0x005a;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.volley.toolbox.DiskBasedCache.initialize():void");
    }
    ...
    static void writeString(OutputStream os, String s) throws IOException {
        byte[] b = s.getBytes(C0747C.UTF8_NAME);
        writeLong(os, (long) b.length);
        os.write(b, 0, b.length);
    }

    static String readString(InputStream is) throws IOException {
        return new String(streamToBytes(is, (int) readLong(is)), C0747C.UTF8_NAME);
    }
