...
public class FastDatePrinter implements DatePrinter, Serializable {
    ...
    private static class TimeZoneDisplayKey {
        ...
        TimeZoneDisplayKey(TimeZone timeZone, boolean daylight, int style, Locale locale) {
            ...
            if (daylight) {
                this.mStyle = LinearLayoutManager.INVALID_OFFSET | style;
            } else {
                this.mStyle = style;
            }
            this.mLocale = locale;
    ...
    private static class TwelveHourField implements NumberRule {
        ...
        public void appendTo(StringBuffer buffer, Calendar calendar) {
            ...
            if (value == 0) {
                value = calendar.getLeastMaximum(10) + FastDatePrinter.LONG;
            }
    ...
    private static class TwentyFourHourField implements NumberRule {
        ...
        public void appendTo(StringBuffer buffer, Calendar calendar) {
            ...
            if (value == 0) {
                value = calendar.getMaximum(11) + FastDatePrinter.LONG;
            }
            this.mRule.appendTo(buffer, value);
        }
    ...
    private static class TwoDigitMonthField implements NumberRule {
        ...
        public void appendTo(StringBuffer buffer, Calendar calendar) {
            appendTo(buffer, calendar.get(FastDatePrinter.MEDIUM) + FastDatePrinter.LONG);
        }
    ...
    private static class TwoDigitYearField implements NumberRule {
        ...
        public void appendTo(StringBuffer buffer, Calendar calendar) {
            appendTo(buffer, calendar.get(FastDatePrinter.LONG) % 100);
        }
