...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C00362 implements Runnable {
        ...
        C00362(String str, Bundle bundle) {
    ...
    private class ServiceImpl {
        ...
        class C00371 implements Runnable {
            ...
            C00371(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00382 implements Runnable {
            ...
            C00382(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C00393 implements Runnable {
            ...
            C00393(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class C00404 implements Runnable {
            ...
            C00404(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class C00415 implements Runnable {
            ...
            C00415(String str, ResultReceiver resultReceiver) {
        ...
        class C00426 implements Runnable {
            ...
            C00426(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C00437 implements Runnable {
            ...
            C00437(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String pkg, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00371(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00382(callbacks));
        }

        public void addSubscription(String id, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00393(callbacks, id, options));
        }

        public void removeSubscription(String id, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00404(callbacks, id, options));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00415(mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00426(callbacks));
        }

        public void unregisterCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00437(callbacks));
        }
    }

    /* renamed from: android.support.v4.media.MediaBrowserServiceCompat.3 */
    class C14943 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C14943(Object x0, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C14954 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C14954(Object x0, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(x0);
        }
    ...
    private class ServiceImplApi23 extends ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi23.ServiceImplApi23 {
        ...
        class C14961 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;

            C14961(Handler x0, ItemCallback itemCallback) {
        ...
        public void getMediaItem(String mediaId, ItemCallback cb) {
            this.mServiceImpl.getMediaItem(mediaId, new C14961(MediaBrowserServiceCompat.this.mHandler, cb));
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00351(token));
        }
    }
    ...
    private void notifyChildrenChangedInternal(String parentId, Bundle options) {
        ...
        this.mHandler.post(new C00362(parentId, options));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C14943(parentId, connection, parentId, options);
        if (options == null) {
            onLoadChildren(parentId, result);
        } else {
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C14954(itemId, receiver);
