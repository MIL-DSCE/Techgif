...
public final class RatingCompat implements Parcelable {
    ...
    static class C00461 implements Creator<RatingCompat> {
        C00461() {
        }
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(RATING_HEART, hasHeart ? TouchHelperCallback.ALPHA_FULL : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(RATING_THUMB_UP_DOWN, thumbIsUp ? TouchHelperCallback.ALPHA_FULL : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != TouchHelperCallback.ALPHA_FULL) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == RATING_THUMB_UP_DOWN && this.mRatingValue == TouchHelperCallback.ALPHA_FULL) {
            return true;
        }
        return false;
    }
