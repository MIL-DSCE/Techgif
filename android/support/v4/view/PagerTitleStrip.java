...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * DefaultLoadControl.DEFAULT_HIGH_BUFFER_LOAD)), LinearLayoutManager.INVALID_OFFSET);
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        if (currOffset > TouchHelperCallback.ALPHA_FULL) {
            currOffset -= TouchHelperCallback.ALPHA_FULL;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (MeasureSpec.getMode(widthMeasureSpec) != C0747C.ENCODING_PCM_32BIT) {
        ...
        this.mCurrText.measure(childWidthSpec, childHeightSpec);
        this.mNextText.measure(childWidthSpec, childHeightSpec);
        if (MeasureSpec.getMode(heightMeasureSpec) == C0747C.ENCODING_PCM_32BIT) {
