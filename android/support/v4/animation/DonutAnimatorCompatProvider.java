...
class DonutAnimatorCompatProvider implements AnimatorProvider {
    ...
    private static class DonutFloatValueAnimator implements ValueAnimatorCompat {
        ...
        class C00001 implements Runnable {
            ...
            public void run() {
                float fraction = (((float) (DonutFloatValueAnimator.this.getTime() - DonutFloatValueAnimator.this.mStartTime)) * TouchHelperCallback.ALPHA_FULL) / ((float) DonutFloatValueAnimator.this.mDuration);
                if (fraction > TouchHelperCallback.ALPHA_FULL || DonutFloatValueAnimator.this.mTarget.getParent() == null) {
                    fraction = TouchHelperCallback.ALPHA_FULL;
                }
                DonutFloatValueAnimator.this.mFraction = fraction;
                DonutFloatValueAnimator.this.notifyUpdateListeners();
                if (DonutFloatValueAnimator.this.mFraction >= TouchHelperCallback.ALPHA_FULL) {
