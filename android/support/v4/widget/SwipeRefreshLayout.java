...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01101 implements AnimationListener {
        C01101() {
        }
    ...
    class C01112 extends Animation {
        C01112() {
        }
    ...
    class C01123 extends Animation {
        C01123() {
        }

        public void applyTransformation(float interpolatedTime, Transformation t) {
            SwipeRefreshLayout.this.setAnimationProgress(TouchHelperCallback.ALPHA_FULL - interpolatedTime);
        }
    }

    /* renamed from: android.support.v4.widget.SwipeRefreshLayout.4 */
    class C01134 extends Animation {
    ...
    class C01145 implements AnimationListener {
        C01145() {
        }
    ...
    class C01156 extends Animation {
        C01156() {
        }
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            SwipeRefreshLayout.this.mProgress.setArrowScale(TouchHelperCallback.ALPHA_FULL - interpolatedTime);
        }
    }

    /* renamed from: android.support.v4.widget.SwipeRefreshLayout.7 */
    class C01167 extends Animation {
        C01167() {
        }
    ...
    class C01178 extends Animation {
        C01178() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01101();
        this.mAnimateToCorrectPosition = new C01156();
        this.mAnimateToStartPosition = new C01167();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01112();
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01123();
    ...
    private Animation startAlphaAnimation(int startingAlpha, int endingAlpha) {
        ...
        Animation alpha = new C01134(startingAlpha, endingAlpha);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mTarget != null) {
            this.mTarget.measure(MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), C0747C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), C0747C.ENCODING_PCM_32BIT));
            this.mCircleView.measure(MeasureSpec.makeMeasureSpec(this.mCircleWidth, C0747C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(this.mCircleHeight, C0747C.ENCODING_PCM_32BIT));
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float dragPercent = Math.min(TouchHelperCallback.ALPHA_FULL, Math.abs(overscrollTop / this.mTotalDragDistance));
        ...
        if (!this.mScale) {
            ViewCompat.setScaleX(this.mCircleView, TouchHelperCallback.ALPHA_FULL);
            ViewCompat.setScaleY(this.mCircleView, TouchHelperCallback.ALPHA_FULL);
        }
        if (this.mScale) {
            setAnimationProgress(Math.min(TouchHelperCallback.ALPHA_FULL, overscrollTop / this.mTotalDragDistance));
        }
        ...
        this.mProgress.setArrowScale(Math.min(TouchHelperCallback.ALPHA_FULL, adjustedPercent));
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01178();
