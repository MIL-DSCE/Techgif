...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    public void invalidateVirtualView(int virtualViewId) {
        sendEventForVirtualView(virtualViewId, MessagesController.UPDATE_MASK_NEW_MESSAGE);
    }
    ...
    private void updateHoveredVirtualView(int virtualViewId) {
        if (this.mHoveredVirtualViewId != virtualViewId) {
            ...
            sendEventForVirtualView(virtualViewId, MessagesController.UPDATE_MASK_USER_PHONE);
            sendEventForVirtualView(previousVirtualViewId, MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE);
        }
    }
    ...
    private AccessibilityNodeInfoCompat createNodeForChild(int virtualViewId) {
        ...
        if ((actions & 64) != 0) {
        ...
        } else if ((actions & MessagesController.UPDATE_MASK_USER_PHONE) != 0) {
            ...
            if (this.mFocusedVirtualViewId == virtualViewId) {
                ...
                node.addAction((int) MessagesController.UPDATE_MASK_USER_PHONE);
            } else {
    ...
    private boolean requestAccessibilityFocus(int virtualViewId) {
        ...
        sendEventForVirtualView(virtualViewId, TLRPC.MESSAGE_FLAG_EDITED);
        return true;
    }
