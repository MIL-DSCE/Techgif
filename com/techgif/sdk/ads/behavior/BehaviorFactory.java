...
public class BehaviorFactory {
    ...
    public BehaviorFactory() {
        ...
        this.POSTLOAD_BEHAVIORS = new String[]{"APPAD-HideTimeout", "APPAD-BannerWidth", "APPAD-BannerHeight", "APPAD-ClickBehaviour", "APPAD-RefreshTimeout"};
    }
    ...
    private BehaviorVisitor _createVisitor(Entry<String, List<String>> header) {
        try {
            ...
            if (headerKey.equalsIgnoreCase("APPAD-HideTimeout")) {
