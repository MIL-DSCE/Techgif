...
public class zzdg implements zzdf {
    ...
    class C02371 implements Runnable {
        ...
        class C02361 implements Runnable {
            ...
            final /* synthetic */ C02371 zzzo;

            C02361(C02371 c02371, JSONObject jSONObject) {
                this.zzzo = c02371;
        ...
        C02371(zzdg com_google_android_gms_internal_zzdg, Map map, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void run() {
            ...
            if (zzQ == null) {
                ...
                zzir.zzMc.post(new C02361(this, zzQ));
            }
        }
    }
        ...
        try {
            ...
            try {
                ...
                if (zza.isSuccess()) {
                    ...
                    jSONObject2.put(LoginTask.BUNDLE_SUCCESS, true);
                    return jSONObject2;
                }
                jSONObject2.put("response", new JSONObject().put("http_request_id", obj));
                jSONObject2.put(LoginTask.BUNDLE_SUCCESS, false);
            ...
            try {
                return new JSONObject().put(LoginTask.BUNDLE_SUCCESS, false);
    ...
    protected JSONObject zza(zzd com_google_android_gms_internal_zzdg_zzd) {
        ...
        try {
            ...
            if (com_google_android_gms_internal_zzdg_zzd.getBody() != null) {
                jSONObject.put(TtmlNode.TAG_BODY, com_google_android_gms_internal_zzdg_zzd.getBody());
            }
    ...
    public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
        zziq.zza(new C02371(this, map, com_google_android_gms_internal_zzjp));
    }
