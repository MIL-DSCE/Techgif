...
public class zzbf extends Thread {
    ...
    class C02271 implements Runnable {
        ...
        C02271(zzbf com_google_android_gms_internal_zzbf, View view) {
    ...
    class C02292 implements Runnable {
        ...
        class C02281 implements ValueCallback<String> {
            final /* synthetic */ C02292 zztl;
        ...
        C02292(zzbf com_google_android_gms_internal_zzbf, zzbc com_google_android_gms_internal_zzbc, WebView webView, boolean z) {
            this.zztg = com_google_android_gms_internal_zzbf;
            this.zzti = com_google_android_gms_internal_zzbc;
            this.zztj = webView;
            this.zztk = z;
            this.zzth = new C02281(this);
        }
        ...
        public void run() {
            if (this.zztj.getSettings().getJavaScriptEnabled()) {
                try {
                    ...
                    this.zzth.onReceiveValue(TtmlNode.ANONYMOUS_REGION_ID);
                }
            }
        }
    }
    ...
    void zza(zzbc com_google_android_gms_internal_zzbc, WebView webView, String str, boolean z) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                String optString = new JSONObject(str).optString(QuicktimeTextSampleEntry.TYPE);
    ...
    boolean zza(WebView webView, zzbc com_google_android_gms_internal_zzbc, boolean z) {
        ...
        com_google_android_gms_internal_zzbc.zzcC();
        webView.post(new C02292(this, com_google_android_gms_internal_zzbc, webView, z));
        return true;
    }
    ...
    boolean zze(View view) {
        ...
        view.post(new C02271(this, view));
        return true;
    }
