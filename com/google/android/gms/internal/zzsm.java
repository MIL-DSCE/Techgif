...
public final class zzsm {
    ...
    private zzsm(byte[] bArr, int i, int i2) {
        this.zzbue = ConnectionsManager.DEFAULT_DATACENTER_ID;
        this.zzbug = 64;
        this.zzbuh = 67108864;
        this.buffer = bArr;
        this.zzbtZ = i;
    ...
    public String readString() throws IOException {
        int zzJf = zzJf();
        if (zzJf > this.zzbua - this.zzbuc || zzJf <= 0) {
            return new String(zzmt(zzJf), C0747C.UTF8_NAME);
        }
        String str = new String(this.buffer, this.zzbuc, zzJf, C0747C.UTF8_NAME);
        this.zzbuc = zzJf + this.zzbuc;
        return str;
    }
    ...
    public long zzJg() throws IOException {
        ...
        for (int i = 0; i < 64; i += 7) {
            ...
            if ((zzJm & MessagesController.UPDATE_MASK_USER_PHONE) == 0) {
                return j;
            }
        }
        throw zzst.zzJu();
    ...
    public int zzJh() throws IOException {
        return (((zzJm() & NalUnitUtil.EXTENDED_SAR) | ((zzJm() & NalUnitUtil.EXTENDED_SAR) << 8)) | ((zzJm() & NalUnitUtil.EXTENDED_SAR) << 16)) | ((zzJm() & NalUnitUtil.EXTENDED_SAR) << 24);
    }
    ...
    public int zzJk() {
        if (this.zzbue == ConnectionsManager.DEFAULT_DATACENTER_ID) {
            return -1;
        }
