...
public class zzbu {
    ...
    public zzbu(Context context, String str) {
        ...
        this.zzxk.put(C2DMessaging.EXTRA_APPLICATION_PENDING_INTENT, context.getApplicationContext() != null ? context.getApplicationContext().getPackageName() : context.getPackageName());
