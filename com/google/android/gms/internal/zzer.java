...
public final class zzer implements zza {
    ...
    class C02561 implements Runnable {
        ...
        C02561(zzer com_google_android_gms_internal_zzer, zzeq com_google_android_gms_internal_zzeq) {
    ...
    static class C19742 extends zzfa.zza {
    ...
    public zzes zza(long j, long j2) {
        ...
        synchronized (this.zzpV) {
            ...
            zzir.zzMc.post(new C02561(this, com_google_android_gms_internal_zzeq));
