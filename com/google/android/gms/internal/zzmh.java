...
public final class zzmh implements zzmg {
    ...
    class C20311 extends zza {
        final /* synthetic */ zzmh zzamB;

        C20311(zzmh com_google_android_gms_internal_zzmh, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzf(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C20311(this, googleApiClient));
    }
}
