...
public class zze {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0159R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        if (!zzafR.get()) {
            ...
            synchronized (zzqy) {
                if (zzafO == null) {
                    ...
                    try {
                        Bundle bundle = context.getPackageManager().getApplicationInfo(context.getPackageName(), MessagesController.UPDATE_MASK_USER_PHONE).metaData;
                        if (bundle != null) {
    ...
    static boolean zzi(Context context, String str) {
        ...
        try {
            return context.getPackageManager().getApplicationInfo(str, MessagesController.UPDATE_MASK_CHANNEL).enabled;
        } catch (NameNotFoundException e) {
            return false;
        }
    }
