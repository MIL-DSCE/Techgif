...
public final class WakeLockEvent extends zzf implements SafeParcelable {
    ...
    public String zzrO() {
        return "\t" + zzrR() + "\t" + zzrT() + "\t" + (zzrU() == null ? TtmlNode.ANONYMOUS_REGION_ID : TextUtils.join(",", zzrU())) + "\t" + zzrV() + "\t" + (zzrS() == null ? TtmlNode.ANONYMOUS_REGION_ID : zzrS()) + "\t" + (zzrW() == null ? TtmlNode.ANONYMOUS_REGION_ID : zzrW()) + "\t" + zzrX();
    }
