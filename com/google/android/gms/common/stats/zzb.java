...
public class zzb {
    ...
    private zzb() {
        ...
        this.zzanu = new zze(MessagesController.UPDATE_MASK_PHONE, ((Long) zza.zzanE.get()).longValue());
        this.zzanw = new zze(MessagesController.UPDATE_MASK_PHONE, ((Long) zza.zzanE.get()).longValue());
    }
    ...
    private static ServiceInfo zzd(Context context, Intent intent) {
        List queryIntentServices = context.getPackageManager().queryIntentServices(intent, MessagesController.UPDATE_MASK_USER_PHONE);
