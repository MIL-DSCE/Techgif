...
public class zzi implements zzh {
    ...
    class C15221 implements zzdf {
        final /* synthetic */ zzi zzyx;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzi.1.1 */
        class C15211 implements zzjq.zza {
            final /* synthetic */ Map zzyy;
            final /* synthetic */ C15221 zzyz;

            C15211(C15221 c15221, Map map) {
                this.zzyz = c15221;
                this.zzyy = map;
            }

            public void zza(zzjp com_google_android_gms_internal_zzjp, boolean z) {
                this.zzyz.zzyx.zzyv = (String) this.zzyy.get(TtmlNode.ATTR_ID);
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.put("messageType", "htmlLoaded");
                    jSONObject.put(TtmlNode.ATTR_ID, this.zzyz.zzyx.zzyv);
        ...
        C15221(zzi com_google_android_gms_ads_internal_formats_zzi) {
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
            this.zzyx.zzpD.zzhU().zza(new C15211(this, map));
            String str = (String) map.get("overlayHtml");
            String str2 = (String) map.get("baseUrl");
            if (TextUtils.isEmpty(str2)) {
                this.zzyx.zzpD.loadData(str, "text/html", C0747C.UTF8_NAME);
            } else {
                this.zzyx.zzpD.loadDataWithBaseURL(str2, str, "text/html", C0747C.UTF8_NAME, null);
            }
        }
    }

    /* renamed from: com.google.android.gms.ads.internal.formats.zzi.2 */
    class C15232 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C15232(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C15243 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C15243(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C15254 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C15254(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C15265 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C15265(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
            ...
            try {
                ...
                jSONObject.put(TtmlNode.ATTR_ID, this.zzyx.zzyv);
    ...
    public zzjp zzdR() {
        ...
        this.zzyr.zza("/loadHtml", new C15221(this));
        this.zzyr.zza("/showOverlay", new C15232(this));
        this.zzyr.zza("/hideOverlay", new C15243(this));
        this.zzpD.zzhU().zza("/hideOverlay", new C15254(this));
        this.zzpD.zzhU().zza("/sendMessageToSdk", new C15265(this));
        return this.zzpD;
    }
