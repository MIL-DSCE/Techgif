...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C01691 implements Runnable {
        ...
        C01691(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C01702 implements Runnable {
        ...
        C01702(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01713 implements Runnable {
        ...
        C01713(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzEe = str;
            this.zzEf = str2;
        }
    ...
    class C01724 implements Runnable {
        ...
        C01724(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01735 implements Runnable {
        ...
        C01735(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01746 implements Runnable {
        ...
        C01746(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01757 implements Runnable {
        ...
        C01757(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    public zzc(Context context, zzt com_google_android_gms_ads_internal_overlay_zzt) {
        ...
        this.zzDP = 0;
        this.zzDQ = 0;
        this.zzDY = TouchHelperCallback.ALPHA_FULL;
    ...
    private void zzfa() {
        Throwable e;
        zzin.m22v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzfb() {
        if (zzfe() && this.zzDR.getCurrentPosition() > 0 && this.zzDQ != 3) {
            zzin.m22v("AdMediaPlayerView nudging MediaPlayer");
            zzb(0.0f);
            this.zzDR.start();
    ...
    private void zzfd() {
        zzin.m22v("AdMediaPlayerView abandon audio focus");
        AudioManager zzfk = zzfk();
        if (zzfk != null && this.zzEa) {
    ...
    private void zzfh() {
        zzin.m22v("AdMediaPlayerView audio focus gained");
        this.zzEa = true;
        zzfj();
    }

    private void zzfi() {
        zzin.m22v("AdMediaPlayerView audio focus lost");
        this.zzEa = false;
        zzfj();
    }
    ...
    private void zzv(boolean z) {
        zzin.m22v("AdMediaPlayerView release");
        if (this.zzDR != null) {
            this.zzDR.reset();
            this.zzDR.release();
            this.zzDR = null;
    ...
    public void onCompletion(MediaPlayer mp) {
        zzin.m22v("AdMediaPlayerView completion");
        zzw(5);
        zzx(5);
        zzir.zzMc.post(new C01702(this));
    }
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        zzw(-1);
        zzx(-1);
        zzir.zzMc.post(new C01713(this, str, str2));
        return true;
    }

    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        String str = (String) zzDN.get(Integer.valueOf(extra));
        zzin.m22v("AdMediaPlayerView MediaPlayer info: " + ((String) zzDN.get(Integer.valueOf(what))) + ":" + str);
        return true;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.zzDT > 0 && this.zzDU > 0) {
            ...
            if (mode == C0747C.ENCODING_PCM_32BIT && mode2 == C0747C.ENCODING_PCM_32BIT) {
            ...
            } else if (mode == C0747C.ENCODING_PCM_32BIT) {
            ...
            } else if (mode2 == C0747C.ENCODING_PCM_32BIT) {
                defaultSize = (this.zzDT * defaultSize2) / this.zzDU;
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzin.m22v("AdMediaPlayerView prepared");
        zzw(2);
        this.zzDO.zzfz();
        zzir.zzMc.post(new C01691(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        zzin.m22v("AdMediaPlayerView surface created");
        zzfa();
        zzir.zzMc.post(new C01724(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        zzin.m22v("AdMediaPlayerView surface destroyed");
        if (this.zzDR != null && this.zzEb == 0) {
            this.zzEb = this.zzDR.getCurrentPosition();
        }
        zzir.zzMc.post(new C01735(this));
        zzv(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int w, int h) {
        Object obj = 1;
        zzin.m22v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzin.m22v("AdMediaPlayerView size changed: " + width + " x " + height);
    ...
    public void pause() {
        zzin.m22v("AdMediaPlayerView pause");
        if (zzfe() && this.zzDR.isPlaying()) {
            this.zzDR.pause();
            zzw(4);
            zzir.zzMc.post(new C01757(this));
        }
        zzx(4);
    }

    public void play() {
        zzin.m22v("AdMediaPlayerView play");
        if (zzfe()) {
            this.zzDR.start();
            zzw(3);
            zzir.zzMc.post(new C01746(this));
        }
        zzx(3);
    }

    public void seekTo(int millis) {
        zzin.m22v("AdMediaPlayerView seek " + millis);
        if (zzfe()) {
    ...
    public void stop() {
        zzin.m22v("AdMediaPlayerView stop");
        if (this.zzDR != null) {
            this.zzDR.stop();
            this.zzDR.release();
            this.zzDR = null;
