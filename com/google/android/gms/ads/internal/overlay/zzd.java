...
public class zzd extends com.google.android.gms.internal.zzfv.zza implements zzs {
    ...
    class C15271 implements com.google.android.gms.internal.zzjq.zza {
        final /* synthetic */ zzd zzEv;

        C15271(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    private class zzd extends zzim {
        ...
        class C01761 implements Runnable {
            ...
            C01761(zzd com_google_android_gms_ads_internal_overlay_zzd_zzd, Drawable drawable) {
        ...
        public void zzbr() {
            ...
            if (zzf != null) {
                zzir.zzMc.post(new C01761(this, zzr.zzbE().zza(this.zzEv.mActivity, zzf, this.zzEv.zzEh.zzEM.zzqo, this.zzEv.zzEh.zzEM.zzqp)));
            }
        }
    }
    ...
    protected void zzx(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzpD.zzhU().zza(new C15271(this));
            if (this.zzEh.url != null) {
                this.zzpD.loadUrl(this.zzEh.url);
            } else if (this.zzEh.zzEH != null) {
                this.zzpD.loadDataWithBaseURL(this.zzEh.zzEF, this.zzEh.zzEH, "text/html", C0747C.UTF8_NAME, null);
            } else {
