...
public class zzk extends FrameLayout implements zzh {
    ...
    private void zzfJ() {
        if (this.zzpD.zzhP() != null && !this.zzEQ) {
            this.zzER = (this.zzpD.zzhP().getWindow().getAttributes().flags & MessagesController.UPDATE_MASK_USER_PHONE) != 0;
            if (!this.zzER) {
                this.zzpD.zzhP().getWindow().addFlags(MessagesController.UPDATE_MASK_USER_PHONE);
                this.zzEQ = true;
            }
        }
    }
    ...
    private void zzfK() {
        if (this.zzpD.zzhP() != null && this.zzEQ && !this.zzER) {
            this.zzpD.zzhP().getWindow().clearFlags(MessagesController.UPDATE_MASK_USER_PHONE);
            this.zzEQ = false;
        }
    }
    ...
    public void zzg(String str, String str2) {
        zza(C2DMBaseReceiver.EXTRA_ERROR, "what", str, "extra", str2);
    }
}
