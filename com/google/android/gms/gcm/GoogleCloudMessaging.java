...
public class GoogleCloudMessaging {
    ...
    class C02161 extends Handler {
        ...
        C02161(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzaLU = new Messenger(new C02161(this, Looper.getMainLooper()));
    }
    ...
    private String zzdZ(String str) {
        ...
        return InstanceID.getInstance(this.context).zzyB().zzi(TtmlNode.ANONYMOUS_REGION_ID, str, INSTANCE_ID_SCOPE);
    }

    private boolean zzr(Intent intent) {
        Object stringExtra = intent.getStringExtra("In-Reply-To");
        if (stringExtra == null && intent.hasExtra(C2DMBaseReceiver.EXTRA_ERROR)) {
    ...
    public synchronized String register(String... senderIds) throws IOException {
        ...
        if (zzaJ(this.context).contains(".gsf")) {
            ...
            bundle.putString(C2DMessaging.EXTRA_SENDER, zzc);
            zzc = zza(zzE(bundle), C2DMBaseReceiver.EXTRA_REGISTRATION_ID);
        }
        return zzc;
    }
