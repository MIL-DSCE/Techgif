...
public class InstanceIDListenerService extends Service {
    ...
    class C02211 extends Handler {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C02211(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C02222 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C02222(InstanceIDListenerService instanceIDListenerService) {
            this.zzaNc = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzaMW = new MessengerCompat(new C02211(this, Looper.getMainLooper()));
        this.zzaMX = new C02222(this);
    }
    ...
    public void zzp(Intent intent) {
        ...
        if (intent.getStringExtra(C2DMBaseReceiver.EXTRA_ERROR) == null && intent.getStringExtra(C2DMBaseReceiver.EXTRA_REGISTRATION_ID) == null) {
            if (Log.isLoggable("InstanceID", 3)) {
