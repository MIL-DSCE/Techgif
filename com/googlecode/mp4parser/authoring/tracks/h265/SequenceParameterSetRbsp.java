...
public class SequenceParameterSetRbsp {
            ...
            while (true) {
                ...
                if (scaling_list_pred_mode_flag[sizeId][matrixId]) {
                    ...
                    for (int i = 0; i < coefNum; i++) {
                        nextCoef = ((nextCoef + bsr.readSE("scaling_list_delta_coef ")) + MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) % MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE;
    ...
    private void profile_tier_level(int maxNumSubLayersMinus1, CAVLCReader bsr) throws IOException {
        ...
        int[] iArr = new int[]{maxNumSubLayersMinus1, 32};
