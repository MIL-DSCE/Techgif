    ...
    class C03641 extends AbstractList<Sample> {
        ...
        class C16651 implements Sample {
            ...
            public void writeTo(WritableByteChannel channel) throws IOException {
                RandomAccessFile raf = new RandomAccessFile(OneJpegPerIframe.this.jpegs[this.val$index], "r");
