...
public class H264TrackImpl extends AbstractH26XTrack {
    ...
    public class ByteBufferBackedInputStream extends InputStream {
        ...
        public int read() throws IOException {
            if (this.buf.hasRemaining()) {
                return this.buf.get() & NalUnitUtil.EXTENDED_SAR;
            }
            return -1;
        }
    ...
    public class SEIMessage {
        ...
        public SEIMessage(InputStream is, SeqParameterSet sps) throws IOException {
            ...
            while (read < datasize) {
                ...
                read++;
                while (last_payload_type_bytes == NalUnitUtil.EXTENDED_SAR) {
                ...
                read++;
                while (last_payload_size_bytes == NalUnitUtil.EXTENDED_SAR) {
    ...
    private void parse(LookAhead la) throws IOException {
        ...
        if (!readSamples(la)) {
            ...
            int i3 = this.firstSeqParameterSet.constraint_set_0_flag ? MessagesController.UPDATE_MASK_USER_PHONE : 0;
