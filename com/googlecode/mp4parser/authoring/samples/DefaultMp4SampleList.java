...
public class DefaultMp4SampleList extends AbstractList<Sample> {
    ...
    class C16571 implements Sample {
        ...
        C16571(long j, ByteBuffer byteBuffer, long j2) {
    ...
    public DefaultMp4SampleList(long track, Container topLevel) {
        ...
        for (TrackBox tb : ((MovieBox) topLevel.getBoxes(MovieBox.class).get(0)).getBoxes(r25)) {
        ...
        while (true) {
            ...
            if (((long) currentChunkNo2) == nextFirstChunk) {
                ...
                if (r0 > s2cIndex2) {
                    ...
                    nextFirstChunk = PtsTimestampAdjuster.DO_NOT_OFFSET;
                    s2cIndex = s2cIndex2;
                }
            } else {
                s2cIndex = s2cIndex2;
    ...
    public Sample get(int index) {
        ...
        return new C16571(this.ssb.getSampleSizeAtIndex(index), correctPartOfChunk, offsetWithInChunk);
    }
