...
public class TrackRunBox extends AbstractFullBox {
    ...
    protected long getContentSize() {
        ...
        long entrySize = 0;
        if ((flags & MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) == MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) {
            entrySize = 0 + 4;
        }
        if ((flags & MessagesController.UPDATE_MASK_SELECT_DIALOG) == MessagesController.UPDATE_MASK_SELECT_DIALOG) {
            entrySize += 4;
        }
        if ((flags & MessagesController.UPDATE_MASK_PHONE) == MessagesController.UPDATE_MASK_PHONE) {
            entrySize += 4;
        }
        if ((flags & MessagesController.UPDATE_MASK_NEW_MESSAGE) == MessagesController.UPDATE_MASK_NEW_MESSAGE) {
            entrySize += 4;
        }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        for (int i = 0; ((long) i) < sampleCount; i++) {
            ...
            if ((getFlags() & MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) == MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) {
                entry.sampleDuration = IsoTypeReader.readUInt32(content);
            }
            if ((getFlags() & MessagesController.UPDATE_MASK_SELECT_DIALOG) == MessagesController.UPDATE_MASK_SELECT_DIALOG) {
                entry.sampleSize = IsoTypeReader.readUInt32(content);
            }
            if ((getFlags() & MessagesController.UPDATE_MASK_PHONE) == MessagesController.UPDATE_MASK_PHONE) {
                entry.sampleFlags = new SampleFlags(content);
            }
            if ((getFlags() & MessagesController.UPDATE_MASK_NEW_MESSAGE) == MessagesController.UPDATE_MASK_NEW_MESSAGE) {
    ...
    public boolean isSampleSizePresent() {
        ...
        return (getFlags() & MessagesController.UPDATE_MASK_SELECT_DIALOG) == MessagesController.UPDATE_MASK_SELECT_DIALOG;
    }

    public boolean isSampleDurationPresent() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(ajc$tjp_7, this, this));
        return (getFlags() & MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) == MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE;
    }

    public boolean isSampleFlagsPresent() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(ajc$tjp_8, this, this));
        return (getFlags() & MessagesController.UPDATE_MASK_PHONE) == MessagesController.UPDATE_MASK_PHONE;
    }

    public boolean isSampleCompositionTimeOffsetPresent() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(ajc$tjp_9, this, this));
        return (getFlags() & MessagesController.UPDATE_MASK_NEW_MESSAGE) == MessagesController.UPDATE_MASK_NEW_MESSAGE;
    }
    ...
    public void setSampleSizePresent(boolean v) {
        ...
        if (v) {
            setFlags(getFlags() | MessagesController.UPDATE_MASK_SELECT_DIALOG);
        } else {
    ...
    public void setSampleDurationPresent(boolean v) {
        ...
        if (v) {
            setFlags(getFlags() | MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE);
        } else {
    ...
    public void setSampleFlagsPresent(boolean v) {
        ...
        if (v) {
            setFlags(getFlags() | MessagesController.UPDATE_MASK_PHONE);
        } else {
    ...
    public void setSampleCompositionTimeOffsetPresent(boolean v) {
        ...
        if (v) {
            setFlags(getFlags() | MessagesController.UPDATE_MASK_NEW_MESSAGE);
        } else {
